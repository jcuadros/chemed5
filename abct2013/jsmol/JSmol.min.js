(function(a,m){"object"===typeof module&&"object"===typeof module.exports?module.exports=a.document?m(a,!0):function(a){if(!a.document)throw Error("jQuery requires a window with a document");return m(a)}:m(a)})("undefined"!==typeof window?window:this,function(a,m){function g(j){var a=j.length,b=h.type(j);return"function"===b||h.isWindow(j)?!1:1===j.nodeType&&a?!0:"array"===b||0===a||"number"===typeof a&&0<a&&a-1 in j}function l(j,a,b){if(h.isFunction(a))return h.grep(j,function(j,c){return!!a.call(j,
c,j)!==b});if(a.nodeType)return h.grep(j,function(j){return j===a!==b});if("string"===typeof a){if(Uc.test(a))return h.filter(a,j,b);a=h.filter(a,j)}return h.grep(j,function(j){return 0<=h.inArray(j,a)!==b})}function e(j,a){do j=j[a];while(j&&1!==j.nodeType);return j}function q(){u.addEventListener?(u.removeEventListener("DOMContentLoaded",d,!1),a.removeEventListener("load",d,!1)):(u.detachEvent("onreadystatechange",d),a.detachEvent("onload",d))}function d(){if(u.addEventListener||"load"===event.type||
"complete"===u.readyState)q(),h.ready()}function c(j,a,b){if(void 0===b&&1===j.nodeType)if(b="data-"+a.replace(Vc,"-$1").toLowerCase(),b=j.getAttribute(b),"string"===typeof b){try{b="true"===b?!0:"false"===b?!1:"null"===b?null:+b+""===b?+b:Wc.test(b)?h.parseJSON(b):b}catch(c){}h.data(j,a,b)}else b=void 0;return b}function b(j){for(var a in j)if(!("data"===a&&h.isEmptyObject(j[a]))&&"toJSON"!==a)return!1;return!0}function f(j,a,b,c){if(h.acceptData(j)){var d=h.expando,f=j.nodeType,k=f?h.cache:j,p=
f?j[d]:j[d]&&d;if(p&&k[p]&&(c||k[p].data)||!(void 0===b&&"string"===typeof a)){p||(p=f?j[d]=$.pop()||h.guid++:d);k[p]||(k[p]=f?{}:{toJSON:h.noop});if("object"===typeof a||"function"===typeof a)c?k[p]=h.extend(k[p],a):k[p].data=h.extend(k[p].data,a);j=k[p];c||(j.data||(j.data={}),j=j.data);void 0!==b&&(j[h.camelCase(a)]=b);"string"===typeof a?(b=j[a],null==b&&(b=j[h.camelCase(a)])):b=j;return b}}}function p(j,a,c){if(h.acceptData(j)){var d,f,k=j.nodeType,p=k?h.cache:j,r=k?j[h.expando]:h.expando;if(p[r]){if(a&&
(d=c?p[r]:p[r].data)){h.isArray(a)?a=a.concat(h.map(a,h.camelCase)):a in d?a=[a]:(a=h.camelCase(a),a=a in d?[a]:a.split(" "));for(f=a.length;f--;)delete d[a[f]];if(c?!b(d):!h.isEmptyObject(d))return}if(!c&&(delete p[r].data,!b(p[r])))return;k?h.cleanData([j],!0):t.deleteExpando||p!=p.window?delete p[r]:p[r]=null}}}function s(){return!0}function k(){return!1}function r(){try{return u.activeElement}catch(j){}}function G(j){var a=Sb.split("|");j=j.createDocumentFragment();if(j.createElement)for(;a.length;)j.createElement(a.pop());
return j}function A(j,a){var b,c,d=0,f=typeof j.getElementsByTagName!==R?j.getElementsByTagName(a||"*"):typeof j.querySelectorAll!==R?j.querySelectorAll(a||"*"):void 0;if(!f){f=[];for(b=j.childNodes||j;null!=(c=b[d]);d++)!a||h.nodeName(c,a)?f.push(c):h.merge(f,A(c,a))}return void 0===a||a&&h.nodeName(j,a)?h.merge([j],f):f}function P(j){kb.test(j.type)&&(j.defaultChecked=j.checked)}function B(j,a){return h.nodeName(j,"table")&&h.nodeName(11!==a.nodeType?a:a.firstChild,"tr")?j.getElementsByTagName("tbody")[0]||
j.appendChild(j.ownerDocument.createElement("tbody")):j}function D(j){j.type=(null!==h.find.attr(j,"type"))+"/"+j.type;return j}function H(j){var a=Xc.exec(j.type);a?j.type=a[1]:j.removeAttribute("type");return j}function I(j,a){for(var b,c=0;null!=(b=j[c]);c++)h._data(b,"globalEval",!a||h._data(a[c],"globalEval"))}function Tb(j,a){if(1===a.nodeType&&h.hasData(j)){var b,c,d;c=h._data(j);var f=h._data(a,c),k=c.events;if(k)for(b in delete f.handle,f.events={},k){c=0;for(d=k[b].length;c<d;c++)h.event.add(a,
b,k[b][c])}f.data&&(f.data=h.extend({},f.data))}}function Ub(j,b){var c=h(b.createElement(j)).appendTo(b.body),d=a.getDefaultComputedStyle?a.getDefaultComputedStyle(c[0]).display:h.css(c[0],"display");c.detach();return d}function Vb(j){var a=u,b=Wb[j];if(!b){b=Ub(j,a);if("none"===b||!b)Ba=(Ba||h("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement),a=(Ba[0].contentWindow||Ba[0].contentDocument).document,a.write(),a.close(),b=Ub(j,a),Ba.detach();Wb[j]=b}return b}function Xb(j,
a){return{get:function(){var b=j();if(null!=b)if(b)delete this.get;else return(this.get=a).apply(this,arguments)}}}function Yb(j,a){if(a in j)return a;for(var b=a.charAt(0).toUpperCase()+a.slice(1),c=a,d=Zb.length;d--;)if(a=Zb[d]+b,a in j)return a;return c}function $b(j,a){for(var b,c,d,f=[],k=0,p=j.length;k<p;k++)if(c=j[k],c.style)if(f[k]=h._data(c,"olddisplay"),b=c.style.display,a)!f[k]&&"none"===b&&(c.style.display=""),""===c.style.display&&Ca(c)&&(f[k]=h._data(c,"olddisplay",Vb(c.nodeName)));
else if(!f[k]&&(d=Ca(c),b&&"none"!==b||!d))h._data(c,"olddisplay",d?b:h.css(c,"display"));for(k=0;k<p;k++)if(c=j[k],c.style&&(!a||"none"===c.style.display||""===c.style.display))c.style.display=a?f[k]||"":"none";return j}function ac(j,a,b){return(j=Yc.exec(a))?Math.max(0,j[1]-(b||0))+(j[2]||"px"):a}function bc(j,a,b,c,d){a=b===(c?"border":"content")?4:"width"===a?1:0;for(var f=0;4>a;a+=2)"margin"===b&&(f+=h.css(j,b+ka[a],!0,d)),c?("content"===b&&(f-=h.css(j,"padding"+ka[a],!0,d)),"margin"!==b&&(f-=
h.css(j,"border"+ka[a]+"Width",!0,d))):(f+=h.css(j,"padding"+ka[a],!0,d),"padding"!==b&&(f+=h.css(j,"border"+ka[a]+"Width",!0,d)));return f}function cc(j,a,b){var c=!0,d="width"===a?j.offsetWidth:j.offsetHeight,f=la(j),k=t.boxSizing()&&"border-box"===h.css(j,"boxSizing",!1,f);if(0>=d||null==d){d=ma(j,a,f);if(0>d||null==d)d=j.style[a];if(La.test(d))return d;c=k&&(t.boxSizingReliable()||d===j.style[a]);d=parseFloat(d)||0}return d+bc(j,a,b||(k?"border":"content"),c,f)+"px"}function N(j,a,b,c,d){return new N.prototype.init(j,
a,b,c,d)}function dc(){setTimeout(function(){ta=void 0});return ta=h.now()}function Ma(j,a){var b,c={height:j},d=0;for(a=a?1:0;4>d;d+=2-a)b=ka[d],c["margin"+b]=c["padding"+b]=j;a&&(c.opacity=c.width=j);return c}function ec(j,a,b){for(var c,d=(Da[a]||[]).concat(Da["*"]),f=0,k=d.length;f<k;f++)if(c=d[f].call(b,a,j))return c}function fc(j,a,b){var c,d,f=0,k=Na.length,p=h.Deferred().always(function(){delete r.elem}),r=function(){if(d)return!1;for(var a=ta||dc(),a=Math.max(0,e.startTime+e.duration-a),
b=1-(a/e.duration||0),c=0,w=e.tweens.length;c<w;c++)e.tweens[c].run(b);p.notifyWith(j,[e,b,a]);if(1>b&&w)return a;p.resolveWith(j,[e]);return!1},e=p.promise({elem:j,props:h.extend({},a),opts:h.extend(!0,{specialEasing:{}},b),originalProperties:a,originalOptions:b,startTime:ta||dc(),duration:b.duration,tweens:[],createTween:function(a,b){var c=h.Tween(j,e.opts,a,b,e.opts.specialEasing[a]||e.opts.easing);e.tweens.push(c);return c},stop:function(a){var b=0,c=a?e.tweens.length:0;if(d)return this;for(d=
!0;b<c;b++)e.tweens[b].run(1);a?p.resolveWith(j,[e,a]):p.rejectWith(j,[e,a]);return this}});a=e.props;b=e.opts.specialEasing;var g,s,l,q;for(c in a)if(g=h.camelCase(c),s=b[g],l=a[c],h.isArray(l)&&(s=l[1],l=a[c]=l[0]),c!==g&&(a[g]=l,delete a[c]),(q=h.cssHooks[g])&&"expand"in q)for(c in l=q.expand(l),delete a[g],l)c in a||(a[c]=l[c],b[c]=s);else b[g]=s;for(;f<k;f++)if(c=Na[f].call(e,j,a,e.opts))return c;h.map(a,ec,e);h.isFunction(e.opts.start)&&e.opts.start.call(j,e);h.fx.timer(h.extend(r,{elem:j,anim:e,
queue:e.opts.queue}));return e.progress(e.opts.progress).done(e.opts.done,e.opts.complete).fail(e.opts.fail).always(e.opts.always)}function gc(j){return function(a,b){"string"!==typeof a&&(b=a,a="*");var c,d=0,f=a.toLowerCase().match(Y)||[];if(h.isFunction(b))for(;c=f[d++];)"+"===c.charAt(0)?(c=c.slice(1)||"*",(j[c]=j[c]||[]).unshift(b)):(j[c]=j[c]||[]).push(b)}}function hc(j,a,b,c){function d(p){var r;f[p]=!0;h.each(j[p]||[],function(j,h){var p=h(a,b,c);if("string"===typeof p&&!k&&!f[p])return a.dataTypes.unshift(p),
d(p),!1;if(k)return!(r=p)});return r}var f={},k=j===lb;return d(a.dataTypes[0])||!f["*"]&&d("*")}function mb(j,a){var b,c,d=h.ajaxSettings.flatOptions||{};for(c in a)void 0!==a[c]&&((d[c]?j:b||(b={}))[c]=a[c]);b&&h.extend(!0,j,b);return j}function nb(j,a,b,c){var d;if(h.isArray(a))h.each(a,function(a,d){b||$c.test(j)?c(j,d):nb(j+"["+("object"===typeof d?a:"")+"]",d,b,c)});else if(!b&&"object"===h.type(a))for(d in a)nb(j+"["+d+"]",a[d],b,c);else c(j,a)}function ob(j){try{return j?new a.ActiveXObject("Microsoft.XMLHTTP"):
new a.XMLHttpRequest}catch(b){}}function ic(){try{return new a.XMLHttpRequest}catch(j){}}function jc(j){return h.isWindow(j)?j:9===j.nodeType?j.defaultView||j.parentWindow:!1}var $=[],aa=$.slice,kc=$.concat,pb=$.push,lc=$.indexOf,Oa={},ad=Oa.toString,ua=Oa.hasOwnProperty,qb="".trim,t={},h=function(j,a){return new h.fn.init(j,a)},bd=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,cd=/^-ms-/,dd=/-([\da-z])/gi,ed=function(j,a){return a.toUpperCase()};h.fn=h.prototype={jquery:"1.11.0",constructor:h,selector:"",
length:0,toArray:function(){return aa.call(this)},get:function(j){return null!=j?0>j?this[j+this.length]:this[j]:aa.call(this)},pushStack:function(j){j=h.merge(this.constructor(),j);j.prevObject=this;j.context=this.context;return j},each:function(j,a){return h.each(this,j,a)},map:function(j){return this.pushStack(h.map(this,function(a,b){return j.call(a,b,a)}))},slice:function(){return this.pushStack(aa.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},
eq:function(j){var a=this.length;j=+j+(0>j?a:0);return this.pushStack(0<=j&&j<a?[this[j]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:pb,sort:$.sort,splice:$.splice};h.extend=h.fn.extend=function(){var j,a,b,c,d,f=arguments[0]||{},k=1,p=arguments.length,r=!1;"boolean"===typeof f&&(r=f,f=arguments[k]||{},k++);"object"!==typeof f&&!h.isFunction(f)&&(f={});k===p&&(f=this,k--);for(;k<p;k++)if(null!=(d=arguments[k]))for(c in d)j=f[c],b=d[c],f!==b&&(r&&b&&(h.isPlainObject(b)||
(a=h.isArray(b)))?(a?(a=!1,j=j&&h.isArray(j)?j:[]):j=j&&h.isPlainObject(j)?j:{},f[c]=h.extend(r,j,b)):void 0!==b&&(f[c]=b));return f};h.extend({expando:"jQuery"+("1.11.0"+Math.random()).replace(/\D/g,""),isReady:!0,error:function(j){throw Error(j);},noop:function(){},isFunction:function(j){return"function"===h.type(j)},isArray:Array.isArray||function(j){return"array"===h.type(j)},isWindow:function(j){return null!=j&&j==j.window},isNumeric:function(j){return 0<=j-parseFloat(j)},isEmptyObject:function(j){for(var a in j)return!1;
return!0},isPlainObject:function(j){var a;if(!j||"object"!==h.type(j)||j.nodeType||h.isWindow(j))return!1;try{if(j.constructor&&!ua.call(j,"constructor")&&!ua.call(j.constructor.prototype,"isPrototypeOf"))return!1}catch(b){return!1}if(t.ownLast)for(a in j)return ua.call(j,a);for(a in j);return void 0===a||ua.call(j,a)},type:function(j){return null==j?j+"":"object"===typeof j||"function"===typeof j?Oa[ad.call(j)]||"object":typeof j},globalEval:function(j){j&&h.trim(j)&&(a.execScript||function(j){a.eval.call(a,
j)})(j)},camelCase:function(j){return j.replace(cd,"ms-").replace(dd,ed)},nodeName:function(j,a){return j.nodeName&&j.nodeName.toLowerCase()===a.toLowerCase()},each:function(j,a,b){var c,d=0,f=j.length;c=g(j);if(b)if(c)for(;d<f&&!(c=a.apply(j[d],b),!1===c);d++);else for(d in j){if(c=a.apply(j[d],b),!1===c)break}else if(c)for(;d<f&&!(c=a.call(j[d],d,j[d]),!1===c);d++);else for(d in j)if(c=a.call(j[d],d,j[d]),!1===c)break;return j},trim:qb&&!qb.call("\ufeff\u00a0")?function(j){return null==j?"":qb.call(j)}:
function(j){return null==j?"":(j+"").replace(bd,"")},makeArray:function(j,a){var b=a||[];null!=j&&(g(Object(j))?h.merge(b,"string"===typeof j?[j]:j):pb.call(b,j));return b},inArray:function(j,a,b){var c;if(a){if(lc)return lc.call(a,j,b);c=a.length;for(b=b?0>b?Math.max(0,c+b):b:0;b<c;b++)if(b in a&&a[b]===j)return b}return-1},merge:function(j,a){for(var b=+a.length,c=0,d=j.length;c<b;)j[d++]=a[c++];if(b!==b)for(;void 0!==a[c];)j[d++]=a[c++];j.length=d;return j},grep:function(j,a,b){for(var c=[],d=
0,f=j.length,k=!b;d<f;d++)b=!a(j[d],d),b!==k&&c.push(j[d]);return c},map:function(j,a,b){var c,d=0,f=j.length,k=[];if(g(j))for(;d<f;d++)c=a(j[d],d,b),null!=c&&k.push(c);else for(d in j)c=a(j[d],d,b),null!=c&&k.push(c);return kc.apply([],k)},guid:1,proxy:function(j,a){var b,c;"string"===typeof a&&(c=j[a],a=j,j=c);if(h.isFunction(j))return b=aa.call(arguments,2),c=function(){return j.apply(a||this,b.concat(aa.call(arguments)))},c.guid=j.guid=j.guid||h.guid++,c},now:function(){return+new Date},support:t});
h.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(j,a){Oa["[object "+a+"]"]=a.toLowerCase()});var rb=a,y=function(j,a,b,c){var d,f,k,h,p;(a?a.ownerDocument||a:S)!==K&&ba(a);a=a||K;b=b||[];if(!j||"string"!==typeof j)return b;if(1!==(h=a.nodeType)&&9!==h)return[];if(X&&!c){if(d=fd.exec(j))if(k=d[1])if(9===h)if((f=a.getElementById(k))&&f.parentNode){if(f.id===k)return b.push(f),b}else return b;else{if(a.ownerDocument&&(f=a.ownerDocument.getElementById(k))&&Ea(a,
f)&&f.id===k)return b.push(f),b}else{if(d[2])return ca.apply(b,a.getElementsByTagName(j)),b;if((k=d[3])&&z.getElementsByClassName&&a.getElementsByClassName)return ca.apply(b,a.getElementsByClassName(k)),b}if(z.qsa&&(!O||!O.test(j))){f=d=F;k=a;p=9===h&&j;if(1===h&&"object"!==a.nodeName.toLowerCase()){h=Pa(j);(d=a.getAttribute("id"))?f=d.replace(gd,"\\$&"):a.setAttribute("id",f);f="[id='"+f+"'] ";for(k=h.length;k--;)h[k]=f+Qa(h[k]);k=sb.test(j)&&tb(a.parentNode)||a;p=h.join(",")}if(p)try{return ca.apply(b,
k.querySelectorAll(p)),b}catch(r){}finally{d||a.removeAttribute("id")}}}var e;a:{j=j.replace(Ra,"$1");f=Pa(j);if(!c&&1===f.length){d=f[0]=f[0].slice(0);if(2<d.length&&"ID"===(e=d[0]).type&&z.getById&&9===a.nodeType&&X&&v.relative[d[1].type]){a=(v.find.ID(e.matches[0].replace(da,ea),a)||[])[0];if(!a){e=b;break a}j=j.slice(d.shift().value.length)}for(h=Sa.needsContext.test(j)?0:d.length;h--;){e=d[h];if(v.relative[k=e.type])break;if(k=v.find[k])if(c=k(e.matches[0].replace(da,ea),sb.test(d[0].type)&&
tb(a.parentNode)||a)){d.splice(h,1);j=c.length&&Qa(d);if(!j){ca.apply(b,c);e=b;break a}break}}}ub(j,f)(c,a,!X,b,sb.test(j)&&tb(a.parentNode)||a);e=b}return e},vb=function(){function j(b,c){a.push(b+" ")>v.cacheLength&&delete j[a.shift()];return j[b+" "]=c}var a=[];return j},T=function(j){j[F]=!0;return j},U=function(j){var a=K.createElement("div");try{return!!j(a)}catch(b){return!1}finally{a.parentNode&&a.parentNode.removeChild(a)}},wb=function(j,a){for(var b=j.split("|"),c=j.length;c--;)v.attrHandle[b[c]]=
a},nc=function(j,a){var b=a&&j,c=b&&1===j.nodeType&&1===a.nodeType&&(~a.sourceIndex||mc)-(~j.sourceIndex||mc);if(c)return c;if(b)for(;b=b.nextSibling;)if(b===a)return-1;return j?1:-1},hd=function(j){return function(a){return"input"===a.nodeName.toLowerCase()&&a.type===j}},id=function(j){return function(a){var b=a.nodeName.toLowerCase();return("input"===b||"button"===b)&&a.type===j}},na=function(j){return T(function(a){a=+a;return T(function(b,c){for(var d,f=j([],b.length,a),k=f.length;k--;)if(b[d=
...
if(!b)break}return a?k.length:k?y.error(j):pc(j,h).slice(0)},Qa=function(j){for(var a=0,b=j.length,c="";a<b;a++)c+=j[a].value;return c},xb=function(j,a,b){var c=a.dir,d=b&&"parentNode"===c,f=ld++;return a.first?function(a,b,f){for(;a=a[c];)if(1===a.nodeType||d)return j(a,b,f)}:function(a,b,w){var k,C,h=[V,f];if(w)for(;a=a[c];){if((1===a.nodeType||d)&&j(a,b,w))return!0}else for(;a=a[c];)if(1===a.nodeType||d){C=a[F]||(a[F]={});if((k=C[c])&&k[0]===V&&k[1]===f)return h[2]=k[2];C[c]=h;if(h[2]=j(a,b,w))return!0}}},
yb=function(j){return 1<j.length?function(a,b,c){for(var d=j.length;d--;)if(!j[d](a,b,c))return!1;return!0}:j[0]},Ta=function(j,a,b,c,d){for(var f,k=[],h=0,p=j.length,r=null!=a;h<p;h++)if(f=j[h])if(!b||b(f,c,d))k.push(f),r&&a.push(h);return k},zb=function(j,a,b,c,d,f){c&&!c[F]&&(c=zb(c));d&&!d[F]&&(d=zb(d,f));return T(function(f,k,h,p){var r,e,g=[],l=[],s=k.length,M;if(!(M=f)){M=a||"*";for(var q=h.nodeType?[h]:h,m=[],G=0,A=q.length;G<A;G++)y(M,q[G],m);M=m}M=j&&(f||!a)?Ta(M,g,j,h,p):M;q=b?d||(f?j:
s||c)?[]:k:M;b&&b(M,q,h,p);if(c){r=Ta(q,l);c(r,[],h,p);for(h=r.length;h--;)if(e=r[h])q[l[h]]=!(M[l[h]]=e)}if(f){if(d||j){if(d){r=[];for(h=q.length;h--;)if(e=q[h])r.push(M[h]=e);d(null,q=[],r,p)}for(h=q.length;h--;)if((e=q[h])&&-1<(r=d?oa.call(f,e):g[h]))f[r]=!(k[r]=e)}}else q=Ta(q===k?q.splice(s,q.length):q),d?d(null,k,q,p):ca.apply(k,q)})},Ab=function(j){var a,b,c,d=j.length,f=v.relative[j[0].type];b=f||v.relative[" "];for(var k=f?1:0,h=xb(function(j){return j===a},b,!0),p=xb(function(j){return-1<
oa.call(a,j)},b,!0),r=[function(j,b,c){return!f&&(c||b!==Ua)||((a=b).nodeType?h(j,b,c):p(j,b,c))}];k<d;k++)if(b=v.relative[j[k].type])r=[xb(yb(r),b)];else{b=v.filter[j[k].type].apply(null,j[k].matches);if(b[F]){for(c=++k;c<d&&!v.relative[j[c].type];c++);return zb(1<k&&yb(r),1<k&&Qa(j.slice(0,k-1).concat({value:" "===j[k-2].type?"*":""})).replace(Ra,"$1"),b,k<c&&Ab(j.slice(k,c)),c<d&&Ab(j=j.slice(c)),c<d&&Qa(j))}r.push(b)}return yb(r)},wa,z,v,Va,qc,ub,Ua,fa,xa,ba,K,Z,X,O,pa,Wa,Ea,F="sizzle"+-new Date,
S=rb.document,V=0,ld=0,rc=vb(),pc=vb(),sc=vb(),Bb=function(j,a){j===a&&(xa=!0);return 0},va="undefined",mc=-2147483648,md={}.hasOwnProperty,ga=[],nd=ga.pop,od=ga.push,ca=ga.push,tc=ga.slice,oa=ga.indexOf||function(j){for(var a=0,b=this.length;a<b;a++)if(this[a]===j)return a;return-1},uc="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),vc="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+uc+")|)|)[\\x20\\t\\r\\n\\f]*\\]",
...
"i";return!j.getAttribute("className")});z.getElementsByTagName=U(function(j){j.appendChild(a.createComment(""));return!j.getElementsByTagName("*").length});z.getElementsByClassName=Fa.test(a.getElementsByClassName)&&U(function(j){j.innerHTML="<div class='a'></div><div class='a i'></div>";j.firstChild.className="i";return 2===j.getElementsByClassName("i").length});z.getById=U(function(j){Z.appendChild(j).id=F;return!a.getElementsByName||!a.getElementsByName(F).length});z.getById?(v.find.ID=function(j,
...
c=[],d=0,f=a.getElementsByTagName(j);if("*"===j){for(;b=f[d++];)1===b.nodeType&&c.push(b);return c}return f};v.find.CLASS=z.getElementsByClassName&&function(j,a){if(typeof a.getElementsByClassName!==va&&X)return a.getElementsByClassName(j)};pa=[];O=[];if(z.qsa=Fa.test(a.querySelectorAll))U(function(j){j.innerHTML="<select t=''><option selected=''></option></select>";j.querySelectorAll("[t^='']").length&&O.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");j.querySelectorAll("[selected]").length||O.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");
...
!j.compareDocumentPosition-!b.compareDocumentPosition;if(c)return c;c=(j.ownerDocument||j)===(b.ownerDocument||b)?j.compareDocumentPosition(b):1;return c&1||!z.sortDetached&&b.compareDocumentPosition(j)===c?j===a||j.ownerDocument===S&&Ea(S,j)?-1:b===a||b.ownerDocument===S&&Ea(S,b)?1:fa?oa.call(fa,j)-oa.call(fa,b):0:c&4?-1:1}:function(j,b){if(j===b)return xa=!0,0;var c,d=0;c=j.parentNode;var f=b.parentNode,k=[j],h=[b];if(!c||!f)return j===a?-1:b===a?1:c?-1:f?1:fa?oa.call(fa,j)-oa.call(fa,b):0;if(c===
f)return nc(j,b);for(c=j;c=c.parentNode;)k.unshift(c);for(c=b;c=c.parentNode;)h.unshift(c);for(;k[d]===h[d];)d++;return d?nc(k[d],h[d]):k[d]===S?-1:h[d]===S?1:0};return a};y.matches=function(j,a){return y(j,null,null,a)};y.matchesSelector=function(j,a){(j.ownerDocument||j)!==K&&ba(j);a=a.replace(pd,"='$1']");if(z.matchesSelector&&X&&(!pa||!pa.test(a))&&(!O||!O.test(a)))try{var b=Wa.call(j,a);if(b||z.disconnectedMatch||j.document&&11!==j.document.nodeType)return b}catch(c){}return 0<y(a,K,null,[j]).length};
y.contains=function(j,a){(j.ownerDocument||j)!==K&&ba(j);return Ea(j,a)};y.attr=function(j,a){(j.ownerDocument||j)!==K&&ba(j);var b=v.attrHandle[a.toLowerCase()],b=b&&md.call(v.attrHandle,a.toLowerCase())?b(j,a,!X):void 0;return void 0!==b?b:z.attributes||!X?j.getAttribute(a):(b=j.getAttributeNode(a))&&b.specified?b.value:null};y.error=function(j){throw Error("Syntax error, unrecognized expression: "+j);};y.uniqueSort=function(j){var a,b=[],c=0,d=0;xa=!z.detectDuplicates;fa=!z.sortStable&&j.slice(0);
j.sort(Bb);if(xa){for(;a=j[d++];)a===j[d]&&(c=b.push(d));for(;c--;)j.splice(b[c],1)}fa=null;return j};Va=y.getText=function(j){var a,b="",c=0;if(a=j.nodeType)if(1===a||9===a||11===a){if("string"===typeof j.textContent)return j.textContent;for(j=j.firstChild;j;j=j.nextSibling)b+=Va(j)}else{if(3===a||4===a)return j.nodeValue}else for(;a=j[c++];)b+=Va(a);return b};v=y.selectors={cacheLength:50,createPseudo:T,match:Sa,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},
...
typeof j.getAttribute!==va&&j.getAttribute("class")||"")})},ATTR:function(j,a,b){return function(c){c=y.attr(c,j);if(null==c)return"!="===a;if(!a)return!0;c+="";return"="===a?c===b:"!="===a?c!==b:"^="===a?b&&0===c.indexOf(b):"*="===a?b&&-1<c.indexOf(b):"$="===a?b&&c.slice(-b.length)===b:"~="===a?-1<(" "+c+" ").indexOf(b):"|="===a?c===b||c.slice(0,b.length+1)===b+"-":!1}},CHILD:function(j,a,b,c,d){var f="nth"!==j.slice(0,3),k="last"!==j.slice(-4),h="of-type"===a;return 1===c&&0===d?function(j){return!!j.parentNode}:
function(a,b,w){var C,p,r,e,g;b=f!==k?"nextSibling":"previousSibling";var l=a.parentNode,s=h&&a.nodeName.toLowerCase();w=!w&&!h;if(l){if(f){for(;b;){for(p=a;p=p[b];)if(h?p.nodeName.toLowerCase()===s:1===p.nodeType)return!1;g=b="only"===j&&!g&&"nextSibling"}return!0}g=[k?l.firstChild:l.lastChild];if(k&&w){w=l[F]||(l[F]={});C=w[j]||[];e=C[0]===V&&C[1];r=C[0]===V&&C[2];for(p=e&&l.childNodes[e];p=++e&&p&&p[b]||(r=e=0)||g.pop();)if(1===p.nodeType&&++r&&p===a){w[j]=[V,e,r];break}}else if(w&&(C=(a[F]||(a[F]=
{}))[j])&&C[0]===V)r=C[1];else for(;p=++e&&p&&p[b]||(r=e=0)||g.pop();)if((h?p.nodeName.toLowerCase()===s:1===p.nodeType)&&++r)if(w&&((p[F]||(p[F]={}))[j]=[V,r]),p===a)break;r-=d;return r===c||0===r%c&&0<=r/c}}},PSEUDO:function(a,b){var c,d=v.pseudos[a]||v.setFilters[a.toLowerCase()]||y.error("unsupported pseudo: "+a);return d[F]?d(b):1<d.length?(c=[a,a,"",b],v.setFilters.hasOwnProperty(a.toLowerCase())?T(function(a,j){for(var c,f=d(a,b),k=f.length;k--;)c=oa.call(a,f[k]),a[c]=!(j[c]=f[k])}):function(a){return d(a,
0,c)}):d}},pseudos:{not:T(function(a){var b=[],c=[],d=ub(a.replace(Ra,"$1"));return d[F]?T(function(a,j,b,c){c=d(a,null,c,[]);for(var f=a.length;f--;)if(b=c[f])a[f]=!(j[f]=b)}):function(a,j,f){b[0]=a;d(b,null,f,c);return!c.pop()}}),has:T(function(a){return function(b){return 0<y(a,b).length}}),contains:T(function(a){return function(b){return-1<(b.textContent||b.innerText||Va(b)).indexOf(a)}}),lang:T(function(a){rd.test(a||"")||y.error("unsupported lang: "+a);a=a.replace(da,ea).toLowerCase();return function(b){var c;
...
return a})}};v.pseudos.nth=v.pseudos.eq;for(wa in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})v.pseudos[wa]=hd(wa);for(wa in{submit:!0,reset:!0})v.pseudos[wa]=id(wa);oc.prototype=v.filters=v.pseudos;v.setFilters=new oc;ub=y.compile=function(a,b){var c,d=[],f=[],k=sc[a+" "];if(!k){b||(b=Pa(a));for(c=b.length;c--;)k=Ab(b[c]),k[F]?d.push(k):f.push(k);var h=0<d.length,p=0<f.length;c=function(a,j,b,c,k){var w,C,r,e=0,g="0",l=a&&[],s=[],q=Ua,M=a||p&&v.find.TAG("*",k),m=V+=null==q?1:Math.random()||
0.1,G=M.length;for(k&&(Ua=j!==K&&j);g!==G&&null!=(w=M[g]);g++){if(p&&w){for(C=0;r=f[C++];)if(r(w,j,b)){c.push(w);break}k&&(V=m)}h&&((w=!r&&w)&&e--,a&&l.push(w))}e+=g;if(h&&g!==e){for(C=0;r=d[C++];)r(l,s,j,b);if(a){if(0<e)for(;g--;)!l[g]&&!s[g]&&(s[g]=nd.call(c));s=Ta(s)}ca.apply(c,s);k&&(!a&&0<s.length&&1<e+d.length)&&y.uniqueSort(c)}k&&(V=m,Ua=q);return l};c=h?T(c):c;k=sc(a,c)}return k};z.sortStable=F.split("").sort(Bb).join("")===F;z.detectDuplicates=!!xa;ba();z.sortDetached=U(function(a){return a.compareDocumentPosition(K.createElement("div"))&
...
yc={};h.Callbacks=function(a){var b;if("string"===typeof a){if(!(b=yc[a])){b=a;var c=yc[b]={};h.each(b.match(Y)||[],function(a,b){c[b]=!0});b=c}}else b=h.extend({},a);a=b;var d,f,k,p,r,e,g=[],l=!a.once&&[],s=function(b){f=a.memory&&b;k=!0;r=e||0;e=0;p=g.length;for(d=!0;g&&r<p;r++)if(!1===g[r].apply(b[0],b[1])&&a.stopOnFalse){f=!1;break}d=!1;g&&(l?l.length&&s(l.shift()):f?g=[]:q.disable())},q={add:function(){if(g){var b=g.length;(function Zc(b){h.each(b,function(b,c){var d=h.type(c);"function"===d?
(!a.unique||!q.has(c))&&g.push(c):c&&(c.length&&"string"!==d)&&Zc(c)})})(arguments);d?p=g.length:f&&(e=b,s(f))}return this},remove:function(){g&&h.each(arguments,function(a,b){for(var j;-1<(j=h.inArray(b,g,j));)g.splice(j,1),d&&(j<=p&&p--,j<=r&&r--)});return this},has:function(a){return a?-1<h.inArray(a,g):!(!g||!g.length)},empty:function(){g=[];p=0;return this},disable:function(){g=l=f=void 0;return this},disabled:function(){return!g},lock:function(){l=void 0;f||q.disable();return this},locked:function(){return!l},
fireWith:function(a,b){if(g&&(!k||l))b=b||[],b=[a,b.slice?b.slice():b],d?l.push(b):s(b);return this},fire:function(){q.fireWith(this,arguments);return this},fired:function(){return!!k}};return q};h.extend({Deferred:function(a){var b=[["resolve","done",h.Callbacks("once memory"),"resolved"],["reject","fail",h.Callbacks("once memory"),"rejected"],["notify","progress",h.Callbacks("memory")]],c="pending",d={state:function(){return c},always:function(){f.done(arguments).fail(arguments);return this},then:function(){var a=
arguments;return h.Deferred(function(j){h.each(b,function(b,c){var k=h.isFunction(a[b])&&a[b];f[c[1]](function(){var a=k&&k.apply(this,arguments);if(a&&h.isFunction(a.promise))a.promise().done(j.resolve).fail(j.reject).progress(j.notify);else j[c[0]+"With"](this===d?j.promise():this,k?[a]:arguments)})});a=null}).promise()},promise:function(a){return null!=a?h.extend(a,d):d}},f={};d.pipe=d.then;h.each(b,function(a,j){var k=j[2],h=j[3];d[j[1]]=k.add;h&&k.add(function(){c=h},b[a^1][2].disable,b[2][2].lock);
f[j[0]]=function(){f[j[0]+"With"](this===f?d:this,arguments);return this};f[j[0]+"With"]=k.fireWith});d.promise(f);a&&a.call(f,f);return f},when:function(a){var b=0,c=aa.call(arguments),d=c.length,f=1!==d||a&&h.isFunction(a.promise)?d:0,k=1===f?a:h.Deferred(),p=function(a,b,j){return function(c){b[a]=this;j[a]=1<arguments.length?aa.call(arguments):c;j===r?k.notifyWith(b,j):--f||k.resolveWith(b,j)}},r,e,g;if(1<d){r=Array(d);e=Array(d);for(g=Array(d);b<d;b++)c[b]&&h.isFunction(c[b].promise)?c[b].promise().done(p(b,
...
Cc=/^([^.]*)(?:\.(.+)|)$/;h.event={global:{},add:function(a,b,c,d,f){var k,p,r,e,g,l,s,q,m;if(r=h._data(a)){c.handler&&(e=c,c=e.handler,f=e.selector);c.guid||(c.guid=h.guid++);if(!(p=r.events))p=r.events={};if(!(g=r.handle))g=r.handle=function(a){return typeof h!==R&&(!a||h.event.triggered!==a.type)?h.event.dispatch.apply(g.elem,arguments):void 0},g.elem=a;b=(b||"").match(Y)||[""];for(r=b.length;r--;)if(k=Cc.exec(b[r])||[],q=l=k[1],m=(k[2]||"").split(".").sort(),q){k=h.event.special[q]||{};q=(f?k.delegateType:
k.bindType)||q;k=h.event.special[q]||{};l=h.extend({type:q,origType:l,data:d,handler:c,guid:c.guid,selector:f,needsContext:f&&h.expr.match.needsContext.test(f),namespace:m.join(".")},e);if(!(s=p[q]))if(s=p[q]=[],s.delegateCount=0,!k.setup||!1===k.setup.call(a,d,m,g))a.addEventListener?a.addEventListener(q,g,!1):a.attachEvent&&a.attachEvent("on"+q,g);k.add&&(k.add.call(a,l),l.handler.guid||(l.handler.guid=c.guid));f?s.splice(s.delegateCount++,0,l):s.push(l);h.event.global[q]=!0}a=null}},remove:function(a,
b,c,d,f){var k,p,r,e,g,l,s,q,m,G,A,P=h.hasData(a)&&h._data(a);if(P&&(l=P.events)){b=(b||"").match(Y)||[""];for(g=b.length;g--;)if(r=Cc.exec(b[g])||[],m=A=r[1],G=(r[2]||"").split(".").sort(),m){s=h.event.special[m]||{};m=(d?s.delegateType:s.bindType)||m;q=l[m]||[];r=r[2]&&RegExp("(^|\\.)"+G.join("\\.(?:.*\\.|)")+"(\\.|$)");for(e=k=q.length;k--;)if(p=q[k],(f||A===p.origType)&&(!c||c.guid===p.guid)&&(!r||r.test(p.namespace))&&(!d||d===p.selector||"**"===d&&p.selector))q.splice(k,1),p.selector&&q.delegateCount--,
s.remove&&s.remove.call(a,p);e&&!q.length&&((!s.teardown||!1===s.teardown.call(a,G,P.handle))&&h.removeEvent(a,m,P.handle),delete l[m])}else for(m in l)h.event.remove(a,m+b[g],c,d,!0);h.isEmptyObject(l)&&(delete P.handle,h._removeData(a,"events"))}},trigger:function(b,c,d,f){var k,p,r,e,g,l,s=[d||u],q=ua.call(b,"type")?b.type:b;g=ua.call(b,"namespace")?b.namespace.split("."):[];r=k=d=d||u;if(!(3===d.nodeType||8===d.nodeType)&&!Bc.test(q+h.event.triggered))if(0<=q.indexOf(".")&&(g=q.split("."),q=g.shift(),
g.sort()),p=0>q.indexOf(":")&&"on"+q,b=b[h.expando]?b:new h.Event(q,"object"===typeof b&&b),b.isTrigger=f?2:3,b.namespace=g.join("."),b.namespace_re=b.namespace?RegExp("(^|\\.)"+g.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=void 0,b.target||(b.target=d),c=null==c?[b]:h.makeArray(c,[b]),g=h.event.special[q]||{},f||!(g.trigger&&!1===g.trigger.apply(d,c))){if(!f&&!g.noBubble&&!h.isWindow(d)){e=g.delegateType||q;Bc.test(e+q)||(r=r.parentNode);for(;r;r=r.parentNode)s.push(r),k=r;if(k===(d.ownerDocument||
u))s.push(k.defaultView||k.parentWindow||a)}for(l=0;(r=s[l++])&&!b.isPropagationStopped();)if(b.type=1<l?e:g.bindType||q,(k=(h._data(r,"events")||{})[b.type]&&h._data(r,"handle"))&&k.apply(r,c),(k=p&&r[p])&&k.apply&&h.acceptData(r))b.result=k.apply(r,c),!1===b.result&&b.preventDefault();b.type=q;if(!f&&!b.isDefaultPrevented()&&(!g._default||!1===g._default.apply(s.pop(),c))&&h.acceptData(d)&&p&&d[q]&&!h.isWindow(d)){(k=d[p])&&(d[p]=null);h.event.triggered=q;try{d[q]()}catch(m){}h.event.triggered=
...
a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){this.isImmediatePropagationStopped=s;this.stopPropagation()}};h.each({mouseenter:"mouseover",mouseleave:"mouseout"},function(a,b){h.event.special[a]={delegateType:b,bindType:b,handle:function(a){var c,j=a.relatedTarget,d=a.handleObj;if(!j||j!==this&&!h.contains(this,j))a.type=d.origType,c=d.handler.apply(this,arguments),a.type=b;return c}}});t.submitBubbles||(h.event.special.submit={setup:function(){if(h.nodeName(this,"form"))return!1;
...
a.nodeName+">")?k=a.cloneNode(!0):(Gb.innerHTML=a.outerHTML,Gb.removeChild(k=Gb.firstChild));if((!t.noCloneEvent||!t.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!h.isXMLDoc(a)){d=A(k);r=A(a);for(p=0;null!=(f=r[p]);++p)if(d[p]){var g=d[p],l=void 0,s=void 0,q=void 0;if(1===g.nodeType){l=g.nodeName.toLowerCase();if(!t.noCloneEvent&&g[h.expando]){q=h._data(g);for(s in q.events)h.removeEvent(g,s,q.handle);g.removeAttribute(h.expando)}if("script"===l&&g.text!==f.text)D(g).text=f.text,H(g);else if("object"===
l)g.parentNode&&(g.outerHTML=f.outerHTML),t.html5Clone&&(f.innerHTML&&!h.trim(g.innerHTML))&&(g.innerHTML=f.innerHTML);else if("input"===l&&kb.test(f.type))g.defaultChecked=g.checked=f.checked,g.value!==f.value&&(g.value=f.value);else if("option"===l)g.defaultSelected=g.selected=f.defaultSelected;else if("input"===l||"textarea"===l)g.defaultValue=f.defaultValue}}}if(b)if(c){r=r||A(a);d=d||A(k);for(p=0;null!=(f=r[p]);p++)Tb(f,d[p])}else Tb(a,k);d=A(k,"script");0<d.length&&I(d,!e&&A(a,"script"));return k},
buildFragment:function(a,b,c,d){for(var f,k,p,r,e,g,l=a.length,s=G(b),q=[],m=0;m<l;m++)if((k=a[m])||0===k)if("object"===h.type(k))h.merge(q,k.nodeType?[k]:k);else if(Bd.test(k)){p=p||s.appendChild(b.createElement("div"));r=(Fc.exec(k)||["",""])[1].toLowerCase();g=Q[r]||Q._default;p.innerHTML=g[1]+k.replace(Ec,"<$1></$2>")+g[2];for(f=g[0];f--;)p=p.lastChild;!t.leadingWhitespace&&Fb.test(k)&&q.push(b.createTextNode(Fb.exec(k)[0]));if(!t.tbody)for(f=(k="table"===r&&!Gc.test(k)?p.firstChild:"<table>"===
g[1]&&!Gc.test(k)?p:0)&&k.childNodes.length;f--;)h.nodeName(e=k.childNodes[f],"tbody")&&!e.childNodes.length&&k.removeChild(e);h.merge(q,p.childNodes);for(p.textContent="";p.firstChild;)p.removeChild(p.firstChild);p=s.lastChild}else q.push(b.createTextNode(k));p&&s.removeChild(p);t.appendChecked||h.grep(A(q,"input"),P);for(m=0;k=q[m++];)if(!(d&&-1!==h.inArray(k,d))&&(a=h.contains(k.ownerDocument,k),p=A(s.appendChild(k),"script"),a&&I(p),c))for(f=0;k=p[f++];)Hc.test(k.type||"")&&c.push(k);return s},
cleanData:function(a,b){for(var c,d,f,k,p=0,r=h.expando,e=h.cache,g=t.deleteExpando,l=h.event.special;null!=(c=a[p]);p++)if(b||h.acceptData(c))if(k=(f=c[r])&&e[f]){if(k.events)for(d in k.events)l[d]?h.event.remove(c,d):h.removeEvent(c,d,k.handle);e[f]&&(delete e[f],g?delete c[r]:typeof c.removeAttribute!==R?c.removeAttribute(r):c[r]=null,$.push(f))}}});h.fn.extend({text:function(a){return qa(this,function(a){return void 0===a?h.text(this):this.empty().append((this[0]&&this[0].ownerDocument||u).createTextNode(a))},
...
b].set=ac)});h.fn.extend({css:function(a,b){return qa(this,function(a,b,c){var d,f={},j=0;if(h.isArray(b)){c=la(a);for(d=b.length;j<d;j++)f[b[j]]=h.css(a,b[j],!1,c);return f}return void 0!==c?h.style(a,b,c):h.css(a,b)},a,b,1<arguments.length)},show:function(){return $b(this,!0)},hide:function(){return $b(this)},toggle:function(a){return"boolean"===typeof a?a?this.show():this.hide():this.each(function(){Ca(this)?h(this).show():h(this).hide()})}});h.Tween=N;N.prototype={constructor:N,init:function(a,
...
h.ajaxSettings),b):mb(h.ajaxSettings,a)},ajaxPrefilter:gc(Oc),ajaxTransport:gc(lb),ajax:function(a,b){function c(a,b,d,f){var j,l,w,B;B=b;if(2!==D){D=2;r&&clearTimeout(r);g=void 0;p=f||"";x.readyState=0<a?4:0;f=200<=a&&300>a||304===a;if(d){w=s;for(var C=x,t,u,W,E,H=w.contents,v=w.dataTypes;"*"===v[0];)v.shift(),void 0===u&&(u=w.mimeType||C.getResponseHeader("Content-Type"));if(u)for(E in H)if(H[E]&&H[E].test(u)){v.unshift(E);break}if(v[0]in d)W=v[0];else{for(E in d){if(!v[0]||w.converters[E+" "+v[0]]){W=
...
H.unshift(w[1]));break}if(!0!==I)if(I&&d["throws"])t=I(t);else try{t=I(t)}catch(F){w={state:"parsererror",error:I?F:"No conversion from "+z+" to "+E};break a}}w={state:"success",data:t}}if(f)s.ifModified&&((B=x.getResponseHeader("Last-Modified"))&&(h.lastModified[k]=B),(B=x.getResponseHeader("etag"))&&(h.etag[k]=B)),204===a||"HEAD"===s.type?B="nocontent":304===a?B="notmodified":(B=w.state,j=w.data,l=w.error,f=!l);else if(l=B,a||!B)B="error",0>a&&(a=0);x.status=a;x.statusText=(b||B)+"";f?G.resolveWith(q,
[j,B,x]):G.rejectWith(q,[x,B,l]);x.statusCode(P);P=void 0;e&&m.trigger(f?"ajaxSuccess":"ajaxError",[x,s,f?j:l]);A.fireWith(q,[x,B]);e&&(m.trigger("ajaxComplete",[x,s]),--h.active||h.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=void 0);b=b||{};var d,f,k,p,r,e,g,l,s=h.ajaxSetup({},b),q=s.context||s,m=s.context&&(q.nodeType||q.jquery)?h(q):h.event,G=h.Deferred(),A=h.Callbacks("once memory"),P=s.statusCode||{},B={},t={},D=0,u="canceled",x={readyState:0,getResponseHeader:function(a){var b;if(2===
...
D)return x;(e=s.global)&&0===h.active++&&h.event.trigger("ajaxStart");s.type=s.type.toUpperCase();s.hasContent=!Sd.test(s.type);k=s.url;s.hasContent||(s.data&&(k=s.url+=(Qb.test(k)?"&":"?")+s.data,delete s.data),!1===s.cache&&(s.url=Mc.test(k)?k.replace(Mc,"$1_="+Pb++):k+(Qb.test(k)?"&":"?")+"_="+Pb++));s.ifModified&&(h.lastModified[k]&&x.setRequestHeader("If-Modified-Since",h.lastModified[k]),h.etag[k]&&x.setRequestHeader("If-None-Match",h.etag[k]));(s.data&&s.hasContent&&!1!==s.contentType||b.contentType)&&
x.setRequestHeader("Content-Type",s.contentType);x.setRequestHeader("Accept",s.dataTypes[0]&&s.accepts[s.dataTypes[0]]?s.accepts[s.dataTypes[0]]+("*"!==s.dataTypes[0]?", "+Pc+"; q=0.01":""):s.accepts["*"]);for(f in s.headers)x.setRequestHeader(f,s.headers[f]);if(s.beforeSend&&(!1===s.beforeSend.call(q,x,s)||2===D))return x.abort();u="abort";for(f in{success:1,error:1,complete:1})x[f](s[f]);if(g=hc(lb,s,b,x)){x.readyState=1;e&&m.trigger("ajaxSend",[x,s]);s.async&&0<s.timeout&&(r=setTimeout(function(){x.abort("timeout")},
s.timeout));try{D=1,g.send(B,c)}catch(H){if(2>D)c(-1,H);else throw H;}}else c(-1,"No Transport");return x},getJSON:function(a,b,c){return h.get(a,b,c,"json")},getScript:function(a,b){return h.get(a,void 0,b,"script")}});h.each(["get","post"],function(a,b){h[b]=function(a,c,d,f){h.isFunction(c)&&(f=f||d,d=c,c=void 0);return h.ajax({url:a,type:b,dataType:f,data:c,success:d})}});h.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){h.fn[b]=function(a){return this.on(b,
...
(c["X-Requested-With"]="XMLHttpRequest");for(f in c)void 0!==c[f]&&k.setRequestHeader(f,c[f]+"");k.send(a.hasContent&&a.data||null);b=function(c,f){var r,e,g;if(b&&(f||4===k.readyState))if(delete ib[p],b=void 0,k.onreadystatechange=h.noop,f)4!==k.readyState&&k.abort();else{g={};r=k.status;"string"===typeof k.responseText&&(g.text=k.responseText);try{e=k.statusText}catch(s){e=""}!r&&a.isLocal&&!a.crossDomain?r=g.text?200:404:1223===r&&(r=204)}g&&d(r,e,g,k.getAllResponseHeaders())};a.async?4===k.readyState?
...
(function(a){function m(a){try{return a?new window.ActiveXObject("Microsoft.XMLHTTP"):new window.XMLHttpRequest}catch(l){}}a.ajaxSettings.xhr=void 0===window.ActiveXObject?m:function(){return(this.url==document.location||0==this.url.indexOf("http")||!this.isLocal)&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&m()||m(1)};a.extend(a.support,{iecors:!!window.XDomainRequest});a.support.iecors?a.ajaxTransport(function(a){return{send:function(l,e){var q=new window.XDomainRequest;q.onload=function(){e(200,
"OK",{text:q.responseText},{"Content-Type":q.contentType})};a.xhrFields&&(q.onerror=a.xhrFields.error,q.ontimeout=a.xhrFields.timeout);q.open(a.type,a.url);q.send(a.hasContent&&a.data||null)},abort:function(){xdr.abort()}}}):(a.ajaxSetup({accepts:{binary:"text/plain; charset=x-user-defined"},responseFields:{binary:"response"}}),a.ajaxTransport("binary",function(a){var l;return{send:function(e,q){var d=a.xhr();d.open(a.type,a.url,a.async);var c=!1;try{d.hasOwnProperty("responseType")&&(d.responseType=
"arraybuffer",c=!0)}catch(b){}try{!c&&d.overrideMimeType&&d.overrideMimeType("text/plain; charset=x-user-defined")}catch(f){}!a.crossDomain&&!e["X-Requested-With"]&&(e["X-Requested-With"]="XMLHttpRequest");try{for(var p in e)d.setRequestHeader(p,e[p])}catch(s){}d.send(a.hasContent&&a.data||null);l=function(){var b=d.status,c="",f=d.getAllResponseHeaders(),p={};try{if(l&&4===d.readyState){l=void 0;try{p.text="string"===typeof d.responseText?d.responseText:null}catch(e){}try{p.binary=d.response}catch(s){}try{c=
d.statusText}catch(m){c=""}!b&&a.isLocal&&!a.crossDomain?b=p.text?200:404:1223===b&&(b=204);q(b,c,p,f)}}catch(H){alert(H),q(-1,H)}};a.async?4===d.readyState?setTimeout(l):d.onreadystatechange=l:l()},abort:function(){}}}))})(jQuery);
(function(a,m,g,l){function e(e,d){function c(c){a(b).each(function(){self.Jmol&&(0<=d.indexOf("mouseup")||0<=d.indexOf("touchend"))&&Jmol._setMouseOwner(null);var b=a(this);this!==c.target&&!b.has(c.target).length&&b.triggerHandler(d,[c.target,c])})}d=d||e+l;var b=a(),f=e+"."+d+"-special-event";a.event.special[d]={setup:function(){b=b.add(this);1===b.length&&a(m).bind(f,c)},teardown:function(){self.Jmol&&Jmol._setMouseOwner(null);b=b.not(this);0===b.length&&a(m).unbind(f)},add:function(a){var b=
a.handler;a.handler=function(a,c){a.target=c;b.apply(this,arguments)}}}}a.map(g.split(" "),function(a){e(a)});e("focusin","focus"+l);e("focusout","blur"+l)})(jQuery,document,"click mousemove mouseup touchmove touchend","outjsmol");"undefined"==typeof jQuery&&alert("Note -- JSmoljQuery is required for JSmol, but it's not defined.");self.Jmol||(Jmol={});
...
d&&!a._canSyncBinary(e);k&&e&&(b=b.replace(/pdb\.gz/,"pdb"),k=!1,d="text");e=0<=b.indexOf("?POST?");0==b.indexOf("file:/")&&0!=b.indexOf("file:///")&&(b="file://"+b.substring(5));var r=0>b.indexOf("://")||0==b.indexOf(document.location.protocol)&&0<=b.indexOf(document.location.host),g=a._isDirectCall(b),l=!r&&a.$supportsIECrossDomainScripting();if(!c||k)if(l||k||!r&&!g)return a._getRawDataFromServer("_",b,c,c,k,!0);b=b.replace(/file:\/\/\/\//,"file://");var q={dataType:d,async:!!c};e?(q.type="POST",
...
c.setDraggable(c.JSDialog);c.getScreenDimensions=function(a){a.width=m(window).width();a.height=m(window).height()};c.dispose=function(b){a.$remove(b.id+"_mover");delete c.htDialogs[b.id];b.container.obj.dragBind(!1)};c.register=function(a,d){a.id=d+ ++c.count;c.htDialogs[a.id]=a};c.setDialog=function(b){a._setMouseOwner(null);a.$remove(b.id);var d=b.id+"_mover",e=a._$(d),g;e[0]?(e.html(b.html),g=e[0].jd):(a.$after("body","<div id='"+d+"' style='position:absolute;left:0px;top:0px;'>"+b.html+"</div>"),
...
d){c._updateMsg=d;var e=a._getAttr(d,"sourceID")||a._getAttr(d,"file");if(e){var k=b.__findView(c._viewSet,{viewID:e});if(null==k)return a.updateView(c,d);k!=c._currentView&&b.__setView(k,c,!0);var r=(e=a._getAttr(d,"atoms"))&&0<=d.indexOf("selectionhalos ON")?eval("["+e+"]"):[];setTimeout(function(){c._currentView==k&&b.updateAtomPick(c,r)},10);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(c,"updateFromSync")}};b.updateAtomPick=function(c,b){var d=c._currentView;if(null!=d){for(var k in d)"info"!=
k&&d[k].applet!=c&&d[k].applet._updateAtomPick(b);a.User.viewUpdatedCallback&&a.User.viewUpdatedCallback(c,"updateAtomPick")}};b.dumpViews=function(a){var c=b.sets[a];if(c){var d="View set "+a+":\n";a=b.applets[a];for(var k in a)d+="\napplet "+a[k]._id+" currentView="+(a[k]._currentView?a[k]._currentView.info.viewID:null);for(k=c.length;0<=--k;){a=c[k];var d=d+("\n\n<b>view="+k+" viewID="+a.info.viewID+" chemID="+a.info.chemID+"</b>\n"),e,g;for(g in a)"info"!=g&&(d+="\nview="+k+" type="+g+" applet="+
((e=a[g]).applet?e.applet._id:null)+" SMILES="+e.smiles+"\n atomMap="+JSON.stringify(e.atomMap)+"\n data=\n"+e.data+"\n")}return d}};b.__init=function(a){var c=a._viewSet,d=b.applets;d[c]||(d[c]={});d[c][a._viewType]=a};b.__findView=function(a,c){var d=b.sets[a];null==d&&(d=b.sets[a]=[]);for(var k=d.length;0<=--k;){var e=d[k];if(c.viewID){if(e.info.viewID==c.viewID)return e}else{if(null!=c.chemID&&c.chemID==e.info.chemID)return e;for(var g in e)if("info"!=g&&(null!=c.data&&null!=e[g].data?c.data==
e[g].data:c.type==g))return e}}return null};b.__createViewSet=function(c,d,e){b.count++;d={info:{chemID:d,viewID:e||"model_"+b.count}};for(var k in a._applets)e=a._applets[k],e._viewSet==c&&(d[e._viewType]={applet:e,data:null});b.sets[c].push(d);return d};b.__setView=function(a,c,b){for(var d in a)if("info"!=d){var e=a[d],g=e.applet,l=b||null!=g&&"<modified>"==g._molData;if(!(null==g||g==c&&!l)){var q=null==e.data,m=null!=g._currentView;g._currentView=a;if(!m||!(a[d].data==e.data&&!q&!l))if(g._loadModelFromView(a),
q)break}}}})(a.View);a.Cache={fileCache:{}};a.Cache.get=function(c){return a.Cache.fileCache[c]};a.Cache.put=function(c,d){a.Cache.fileCache[c]=d};a.Cache.setDragDrop=function(c){a.$appEvent(c,"appletdiv","dragover",function(a){a=a.originalEvent;a.stopPropagation();a.preventDefault();a.dataTransfer.dropEffect="copy"});a.$appEvent(c,"appletdiv","drop",function(d){d=d.originalEvent;d.stopPropagation();d.preventDefault();var e=d.dataTransfer.files[0];d=new FileReader;d.onloadend=function(d){if(d.target.readyState==
FileReader.DONE){var k="cache://DROP_"+e.name;d=a._toBytes(d.target.result);c._applet.viewer.cacheFileByName("cache://DROP_*",!1);"JSV"==c._viewType||k.endsWith(".jdx")?a.Cache.put(k,d):c._applet.viewer.cachePut(k,d);c._applet.viewer.openFileAsyncSpecial(k,1)}};d.readAsArrayBuffer(e)})}})(Jmol,jQuery);Jmol._debugCode=!1;
...
m)+".z.js"];if(l&&(l=l.split(" ")))for(m=0;m<l.length;m++)0>a.__coreMore.join("").indexOf(l[m])&&a.__coreMore.push(g+"/core/core"+l[m]+".z.js");for(m=0;m<a.__coreMore.length;m++)a._coreFiles.push(a.__coreMore[m])}};a.__nextExecution=function(m){delete a.__execTimer;for(var g=a.__execStack,l;0<g.length&&"done"==(l=g[0])[4];)g.shift();0!=g.length&&(m?(l.push("done"),m="JSmol exec "+l[0]._id+" "+l[3]+" "+l[2],self.console&&console.log(m+" -- OK"),a.__execLog.push(m),l[1](l[0],l[2])):setTimeout("Jmol.__nextExecution(true)",
...
function(m,g,l,e){this._uniqueId=(""+Math.random()).substring(3);this._id=m;this._is2D=!0;this._isJava=!1;this._jmolType="Jmol._Canvas2D ("+l+")";switch(l){case "Jmol":this._platform="J.awtjs2d.Platform";break;case "JSV":this._isLayered=this._isJSV=!0,this._platform="JSV.awtjs2d.Platform"}if(e)return this;window[m]=this;this._createCanvas(m,g);if(!a._document||this._deferApplet)return this;this._init();return this};a._jsSetPrototype=function(m){m._init=function(){this._setupJS();this._showInfo(!0);
this._disableInitialConsole&&this._showInfo(!1)};m._createCanvas=function(g,l,e){a._setObject(this,g,l);e&&(this._GLmol=e,this._GLmol.applet=this,this._GLmol.id=this._id);e=a._getWrapper(this,!0);this._deferApplet||(a._document?(a._documentWrite(e),this._getCanvas(!1),e=""):(this._deferApplet=!0,e+='<script type="text/javascript">'+g+"._cover(false)\x3c/script>"));e+=a._getWrapper(this,!1);l.addSelectionOptions&&(e+=a._getGrabberOptions(this));a._debugAlert&&!a._document&&alert(e);this._code=a._documentWrite(e)};
m._cover=function(g){if(g||!this._deferApplet)this._displayCoverImage(g);else{var l=this._coverScript?this._coverScript:"";this._coverScript="";this._deferUncover&&(l+=";refresh;javascript "+this._id+"._displayCoverImage(false)");this._script(l,!0);this._deferUncover&&"activate 3D model"==this._coverTitle&&(a._getElement(this,"coverimage").title="3D model is loading...");this._start();this._deferUncover||this._displayCoverImage(g);this._init&&this._init()}};m._displayCoverImage=function(g){this._coverImage&&
this._isCovered!=g&&(this._isCovered=g,a._getElement(this,"coverdiv").style.display=g?"block":"none")};m._start=function(){this._deferApplet&&this._getCanvas(!1);this._defaultModel&&a._search(this,this._defaultModel);this._showInfo(!1)};m._getCanvas=function(a){this._is2D?this._createCanvas2d(a):this._GLmol.create()};m._createCanvas2d=function(g){var l=a.$(this,"appletdiv");if(g)try{l[0].removeChild(this._canvas),this._canvas.frontLayer&&l[0].removeChild(this._canvas.frontLayer),this._canvas.rearLayer&&
l[0].removeChild(this._canvas.rearLayer),this._canvas.imageLayer&&l[0].removeChild(this._canvas.imageLayer),a._jsUnsetMouse(this._mouseInterface)}catch(e){}g=Math.round(l.width());var q=Math.round(l.height()),d=document.createElement("canvas");d.applet=this;this._canvas=d;d.style.width="100%";d.style.height="100%";d.width=g;d.height=q;d.id=this._id+"_canvas2d";l.append(d);a._$(d.id).css({"z-index":a._getZ(this,"main")});if(this._isLayered){var c=document.createElement("div");d.imageLayer=c;c.id=this._id+
"_imagelayer";l.append(c);a._$(c.id).css({zIndex:a._getZ(this,"image"),position:"absolute",left:"0px",top:"0px",width:"0px",height:"0px",overflow:"hidden"});this._mouseInterface=this._getLayer("front",l,g,q,!1)}else this._mouseInterface=d;a._jsSetMouse(this._mouseInterface)};m._getLayer=function(g,l,e,q,d){var c=document.createElement("canvas");this._canvas[g+"Layer"]=c;c.style.width="100%";c.style.height="100%";c.id=this._id+"_"+g+"Layer";c.width=e;c.height=q;l.append(c);c.applet=this;a._$(c.id).css({background:d?
"rgb(0,0,0,1)":"rgb(0,0,0,0.001)","z-index":a._getZ(this,g),position:"absolute",left:"0px",top:"0px",overflow:"hidden"});return c};m._setupJS=function(){window["j2s.lib"]={base:this._j2sPath+"/",alias:".",console:this._console,monitorZIndex:a._getZ(this,"monitorZIndex")};0==a.__execStack.length&&a.__addExec([this,a.__loadClazz,null,"loadClazz"]);this._isJSV?(a.__addCoreFile("jsv",this._j2sPath,this.__Info.preloadCore),a._debugCode&&(a.__addExec([this,a.__loadClass,"JSV.appletjs.JSVApplet","load JSV"]),
...
clearTimeout(a.__execTimer);a.__execTimer=setTimeout(a.__nextExecution,a.__execDelayMS)};m.__startAppletJS=function(g){var l=new java.util.Hashtable;a._setJmolParams(l,g.__Info,!0);l.put("appletReadyCallback","Jmol._readyCallback");l.put("applet",!0);l.put("name",g._id);l.put("syncId",a._syncId);g._color&&l.put("bgcolor",g._color);g._is2D?g._startupScript&&l.put("script",g._startupScript):l.put("script","set multipleBondSpacing 0.35;");a._syncedApplets.length&&l.put("synccallback","Jmol._mySyncCallback");
l.put("signedApplet","true");l.put("platform",g._platform);g._is2D&&l.put("display",g._id+"_canvas2d");l.put("documentBase",document.location.href);var e=g._j2sPath+"/";if(0>e.indexOf("://")){var q=document.location.href.split("#")[0].split("?")[0].split("/");q[q.length-1]=e;e=q.join("/")}l.put("codePath",e);a._registerApplet(g._id,g);g._applet=!g._isJSV?new J.appletjs.Jmol(l):g._isPro?new JSV.appletjs.JSVAppletPro(l):new JSV.appletjs.JSVApplet(l);g._is2D||(g._GLmol.applet=g);g._jsSetScreenDimensions();
a.__nextExecution()};m._jsSetScreenDimensions=function(){if(this._applet){var g=a._getElement(this,this._is2D?"canvas2d":"canvas");this._applet.viewer.setScreenDimension(g.width,g.height)}};m._show=function(g){a.$setVisible(a.$(this,"appletdiv"),g);g&&a._repaint(this,!0)};m._canScript=function(){return!0};m._delay=function(a,l,e){this._delayID=setTimeout(function(){a.resumeEval(l,!1)},e)};m._createDomNode=function(a,l){a=this._id+"_"+a;var e=document.getElementById(a);e&&document.body.removeChild(e);
if(l){0==l.indexOf("<?")&&(l=l.substring(l.indexOf("<",1)));if(0<=l.indexOf("/>")){for(var e=l.split("/>"),q=e.length-1;0<=--q;)for(var d=e[q],c=d.lastIndexOf("<")+1,b=c,f=d.length,p="";++b<f;)if(0<=" \t\n\r".indexOf(d.charAt(b))){p=d.substring(c,b);e[q]=d+"></"+p+">";break}l=e.join("")}e=document.createElement("_xml");e.id=a;e.innerHTML=l;e.style.display="none";document.body.appendChild(e);return e}};m.equals=function(a){return this==a};m.clone=function(){return this};m.hashCode=function(){return parseInt(this._uniqueId)};
m._processGesture=function(a){return this._applet.viewer.mouse.processTwoPointGesture(a)};m._processEvent=function(a,l){this._applet.viewer.processMouseEvent(a,l[0],l[1],l[2],System.currentTimeMillis())};m._resize=function(){var g="__resizeTimeout_"+this._id;a[g]&&clearTimeout(a[g]);var l=this;a[g]=setTimeout(function(){a._repaint(l,!0);a[g]=null},100)};return m};a._repaint=function(m,g){if(m&&m._applet){var l=a.$(m,"appletdiv"),e=Math.round(l.width()),l=Math.round(l.height());if(m._is2D&&(m._canvas.width!=
e||m._canvas.height!=l))m._getCanvas(!0),m._applet.viewer.setDisplay(m._canvas);m._applet.viewer.setScreenDimension(e,l);g?setTimeout(function(){m._applet&&m._applet.viewer.updateJS(0,0)}):m._applet.viewer.updateJS(0,0)}};a._getHiddenCanvas=function(a,g,l,e,q){g=a._id+"_"+g;(a=document.getElementById(g))&&q&&(a=null);a||(a=document.createElement("canvas"));a.width=a.style.width=l;a.height=a.style.height=e;a.id!=g&&(a.id=g);return a};a._loadImage=function(m,g,l,e,q){var d=g[1];if(null==q)return q=
new Image,q.onload=function(){a._loadImage(m,g,null,e,q)},null!=l&&(l=J.io.Base64.getBase64(l).toString(),l=d.substring(url.lastIndexOf("/")+1),0<=l.indexOf(".png")||l.indexOf(".jpg")),q.src=d,!0;l=q.width;var c=q.height,b="echo_"+g[0],f=a._getHiddenCanvas(m.vwr.applet,b,l,c,!0);f.imageWidth=l;f.imageHeight=c;f.id=b;f.image=q;a._setCanvasImage(f,l,c);e(f,d)};a._setCanvasImage=function(a,g,l){a.buf32=null;a.width=g;a.height=l;a.getContext("2d").drawImage(a.image,0,0,g,l)}})(Jmol);
...
p+"<table bgcolor='yellow'><tr><td align='center' valign='middle' "+f+">\n"+g._noJavaMsg+"</td></tr></table></applet>\n";p=a._getWrapper(e,!0)+p+a._getWrapper(e,!1)+(l.addSelectionOptions?a._getGrabberOptions(e):"");a._debugAlert&&alert(p);e._code=a._documentWrite(p)};l._create=function(e,l){a._setObject(this,e,l);var d={syncId:a._syncId,progressbar:"true",progresscolor:"blue",boxbgcolor:this._color||"black",boxfgcolor:"white",boxmessage:"Downloading JmolApplet ...",script:this._color?'background "'+
...
function(e,g,d,c){d&&(a._setDestroy(this),this._ready=!0,e=this._readyScript,this._applet=c,this._defaultModel?a._search(this,this._defaultModel,e?";"+e:""):e?this._script(e):this._src&&this._script('load "'+this._src+'"'),this._showInfo(!0),this._showInfo(!1),a.Cache.setDragDrop(this),this._readyFunction&&this._readyFunction(this),a._setReady(this),(c=this._2dapplet)&&(c._isEmbedded&&c._ready&&c.__Info.visible)&&this._show2d(!0))};l._showInfo=function(e){e&&this._2dapplet&&this._2dapplet._show(!1);
a.$html(a.$(this,"infoheaderspan"),this._infoHeader);this._info&&a.$html(a.$(this,"infodiv"),this._info);if(!this._isInfoVisible!=!e){this._isInfoVisible=e;if(this._isJava){var g=e?2:"100%";a.$setSize(a.$(this,"appletdiv"),g,g)}a.$setVisible(a.$(this,"infotablediv"),e);a.$setVisible(a.$(this,"infoheaderdiv"),e);this._show(!e)}};l._show2d=function(a){this._2dapplet._show2d(a);this._2dapplet._isEmbedded&&(this._showInfo(!1),this._show(!a))};l._getAtomCorrelation=function(a){this._loadMolData(a,"atommap = compare({1.1} {2.1} 'MAP' 'H'); zap 2.1",
!0);a=jmol._evaluate("atommap");for(var g=jmol._evaluate("{*}.count"),d=[],c=[],b=0;b<a.length;b++){var f=a[b];d[f[0]+1]=f[1]-g+1;c[f[1]-g+1]=f[0]+1}return{fromJmol:d,toJmol:c}};l._show=function(e){var g=!e?2:"100%";a.$setSize(a.$(this,"object"),g,g);this._isJava||a.$setVisible(a.$(this,"appletdiv"),e)};l._clearConsole=function(){this._console==this._id+"_infodiv"&&(this.info="");self.Clazz&&(a._setConsoleDiv(this._console),Clazz.Console.clear())};l._addScript=function(a){this._readyScript||(this.readyScript=
"");this._readyScript&&(this._readyScript+=";");this._readyScript+=a;return!0};l._script=function(e){if(!this._ready)return this._addScript(e);a._setConsoleDiv(this._console);this._applet.script(e)};l._syncScript=function(a){this._applet.syncScript(a)};l._scriptCheck=function(a){return this._ready&&this._applet.scriptCheck(a)};l._scriptWait=function(a,g){var d=this._scriptWaitAsArray(a),c="";if(!g)for(var b=d.length;0<=--b;)for(var f=0,l=d[b].length;f<l;f++)c+=d[b][f]+"\n";return c};l._scriptEcho=
function(a){a=this._scriptWaitAsArray(a);for(var g="",d=a.length;0<=--d;)for(var c=a[d].length;0<=--c;)"scriptEcho"==a[d][c][1]&&(g+=a[d][c][3]+"\n");return g.replace(/ \| /g,"\n")};l._scriptMessage=function(a){a=this._scriptWaitAsArray(a);for(var g="",d=a.length;0<=--d;)for(var c=a[d].length;0<=--c;)"scriptStatus"==a[d][c][1]&&(g+=a[d][c][3]+"\n");return g.replace(/ \| /g,"\n")};l._scriptWaitOutput=function(a){var g="";try{a&&(g+=this._applet.scriptWaitOutput(a))}catch(d){}return g};l._scriptWaitAsArray=
function(e){var g="";try{if(this._getStatus("scriptEcho,scriptMessage,scriptStatus,scriptError"),e&&(g+=this._applet.scriptWait(e),g=a._evalJSON(g,"jmolStatus"),"object"==typeof g))return g}catch(d){}return[[g]]};l._getStatus=function(e){return a._sortMessages(this._getPropertyAsArray("jmolStatus",e))};l._getPropertyAsArray=function(e,g){return a._evalJSON(this._getPropertyAsJSON(e,g),e)};l._getPropertyAsString=function(a,g){void 0==g&&(g="");return this._applet.getPropertyAsString(a,g)+""};l._getPropertyAsJSON=
function(a,g){void 0==g&&(g="");try{return this._applet.getPropertyAsJSON(a,g)+""}catch(d){return""}};l._getPropertyAsJavaObject=function(a,g){void 0==g&&(g="");return this._applet.getProperty(a,g)};l._evaluate=function(a){null!=a||(a="");return this._getPropertyAsArray("variableInfo",a)};l._evaluateDEPRECATED=function(a){a=""+this._getPropertyAsJavaObject("evaluate",a);var g=a.replace(/\-*\d+/,"");if(""==g&&!isNaN(parseInt(a)))return parseInt(a);g=a.replace(/\-*\d*\.\d*/,"");return""==g&&!isNaN(parseFloat(a))?
parseFloat(a):a};l._saveOrientation=function(a){return this._savedOrientations[a]=this._getPropertyAsArray("orientationInfo","info").moveTo};l._restoreOrientation=function(a){a=this._savedOrientations[a];return!a||""==a?a.replace(/1\.0/,"0"):this._scriptWait(a)};l._restoreOrientationDelayed=function(a,g){1>arguments.length&&(g=1);var d=this._savedOrientations[a];return!d||""==d?d.replace(/1\.0/,g):this._scriptWait(d)};l._resizeApplet=function(e){function g(c,b){var d=""+c;return 0==d.length?b?"":
...
m._addScript=function(a,l){var e=m._scripts.length;m._scripts[e]=[a,l];return e};m._getIdForControl=function(a,l){return"string"==typeof a?a:!l||!a._canScript||a._canScript(l)?a._id:null};m._radio=function(a,l,e,q,d,c,b,f){var p=m._getIdForControl(a,l);if(null==p)return null;++m._radioCount;void 0!=c&&null!=c||(c="jmolRadioGroup"+(m._radioGroupCount-1));if(!l)return"";void 0!=b&&null!=b||(b="jmolRadio"+(m._radioCount-1));void 0!=e&&null!=e||(e=l.substring(0,32));d||(d="");a="</span>";m._actions[b]=
m._addScript(p,l);l='<span id="span_'+b+'"'+(f?' title="'+f+'"':"")+"><input name='"+c+"' id='"+b+"' type='radio' onclick='Jmol.controls._click(this);return true;' onmouseover='Jmol.controls._mouseOver(this);return true;' onmouseout='Jmol.controls._mouseOut()' "+(q?"checked='true' ":"")+m._radioCssText+" />";0<=e.toLowerCase().indexOf("<td>")&&(l+=a,a="");return l+('<label for="'+b+'">'+e+"</label>"+a+d)};m._scriptExecute=function(g,l){var e=a._applets[l[0]],m=l[1];if("object"==typeof m)m[0](g,m,
e);else"function"==typeof m?m(e):a.script(e,m)};m.__checkScript=function(a,l){var e=0<=l.value.indexOf("JSCONSOLE ")||""===a._scriptCheck(l.value);l.style.color=e?"black":"red";return e};m.__getCmd=function(a,l){if(l._cmds&&l._cmds.length){var e=l._cmds[l._cmdpt=(l._cmdpt+l._cmds.length+a)%l._cmds.length];setTimeout(function(){l.value=e},10);l._cmdadd=1;l._cmddir=a}};m._commandKeyPress=function(g,l,e){g=13==g?13:window.event?window.event.keyCode:g?g.keyCode||g.which:0;var q=document.getElementById(l),
d=a._applets[e];switch(g){case 13:l=q.value;if(m.__checkScript(d,q)&&(m._scriptExecute(q,[e,l])||1))q._cmds||(q._cmds=[],q._cmddir=0,q._cmdpt=-1,q._cmdadd=0),l&&0==q._cmdadd?(++q._cmdpt,q._cmds.splice(q._cmdpt,0,l),q._cmdadd=0,q._cmddir=0):q._cmdadd=0,q.value="";return!1;case 27:return setTimeout(function(){q.value=""},20),!1;case 38:m.__getCmd(-1,q);break;case 40:m.__getCmd(1,q);break;default:q._cmdadd=0}setTimeout(function(){m.__checkScript(d,q)},20);return!0};m._click=function(a,l){m._element=
a;1==arguments.length&&(l=m._actions[a.id]);m._scriptExecute(a,m._scripts[l])};m._menuSelected=function(a){var l=a.value;if(void 0!=l)m._scriptExecute(a,m._scripts[l]);else{l=a.length;if("number"==typeof l)for(var e=0;e<l;++e)if(a[e].selected){m._click(a[e],a[e].value);return}alert("?Que? menu selected bug #8734")}};m._cbNotifyMaster=function(a){var l=!0,e=!0,q;for(q in a.chkGroup)a.chkGroup[q].checked?e=!1:l=!1;l&&(a.chkMaster.checked=!0);e&&(a.chkMaster.checked=!1);(l||e)&&m._checkboxItems[a.chkMaster.id]&&
m._cbNotifyMaster(m._checkboxItems[a.chkMaster.id])};m._cbNotifyGroup=function(a,l){for(var e in a.chkGroup){var q=a.chkGroup[e];q.checked!=l&&(q.checked=l,m._cbClick(q));m._checkboxMasters[q.id]&&m._cbNotifyGroup(m._checkboxMasters[q.id],l)}};m._cbSetCheckboxGroup=function(a,l,e){var q=a;"number"==typeof q&&(q="jmolCheckbox"+q);(a=document.getElementById(q))||alert("jmolSetCheckboxGroup: master checkbox not found: "+q);var d=m._checkboxMasters[q]={};d.chkMaster=a;d.chkGroup={};"string"==typeof l?
(l=e,q=1):q=0;for(a=q;a<l.length;a++)q=l[a],"number"==typeof q&&(q="jmolCheckbox"+q),(checkboxItem=document.getElementById(q))||alert("jmolSetCheckboxGroup: group checkbox not found: "+q),d.chkGroup[q]=checkboxItem,m._checkboxItems[q]=d};m._cbClick=function(a){m._control=a;var l=m._actions[a.id][0],e=m._actions[a.id][1];m._click(a,a.checked?l:e);m._checkboxMasters[a.id]&&m._cbNotifyGroup(m._checkboxMasters[a.id],a.checked);m._checkboxItems[a.id]&&m._cbNotifyMaster(m._checkboxItems[a.id])};m._cbOver=
function(a){var l=m._actions[a.id][0],e=m._actions[a.id][1];window.status=m._scripts[a.checked?e:l]};m._mouseOver=function(a,l){1==arguments.length&&(l=m._actions[a.id]);window.status=m._scripts[l]};m._mouseOut=function(){window.status=" ";return!0};m._onloadResetForms=function(){m._hasResetForms||(m._hasResetForms=!0,m._previousOnloadHandler=window.onload,window.onload=function(){if(0<m._buttonCount+m._checkboxCount+m._menuCount+m._radioCount+m._radioGroupCount)for(var a=document.forms,l=a.length;0<=
--l;)a[l].reset();m._previousOnloadHandler&&m._previousOnloadHandler()})};m._getButton=function(g,l,e,q,d){g=m._getIdForControl(g,l);if(null==g)return"";void 0!=q&&null!=q||(q="jmolButton"+m._buttonCount);void 0!=e&&null!=e||(e=l.substring(0,32));++m._buttonCount;m._actions[q]=m._addScript(g,l);l='<span id="span_'+q+'"'+(d?' title="'+d+'"':"")+"><input type='button' name='"+q+"' id='"+q+"' value='"+e+"' onclick='Jmol.controls._click(this)' onmouseover='Jmol.controls._mouseOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+
m._buttonCssText+" /></span>";a._debugAlert&&alert(l);return a._documentWrite(l)};m._getCheckbox=function(g,l,e,q,d,c,b){var f=m._getIdForControl(g,l);null!=f&&(f=m._getIdForControl(g,e));if(null==f)return"";void 0!=c&&null!=c||(c="jmolCheckbox"+m._checkboxCount);++m._checkboxCount;if(void 0==l||null==l||void 0==e||null==e)alert("jmolCheckbox requires two scripts");else if(void 0==q||null==q)alert("jmolCheckbox requires a label");else return m._actions[c]=[m._addScript(f,l),m._addScript(f,e)],g="</span>",
d='<span id="span_'+c+'"'+(b?' title="'+b+'"':"")+"><input type='checkbox' name='"+c+"' id='"+c+"' onclick='Jmol.controls._cbClick(this)' onmouseover='Jmol.controls._cbOver(this);return true' onmouseout='Jmol.controls._mouseOut()' "+(d?"checked='true' ":"")+m._checkboxCssText+" />",0<=q.toLowerCase().indexOf("<td>")&&(d+=g,g=""),d+='<label for="'+c+'">'+q+"</label>"+g,a._debugAlert&&alert(d),a._documentWrite(d)};m._getCommandInput=function(g,l,e,q,d){g=m._getIdForControl(g,"x");if(null==g)return"";
void 0!=q&&null!=q||(q="jmolCmd"+m._cmdCount);void 0!=l&&null!=l||(l="Execute");void 0!=e&&!isNaN(e)||(e=60);++m._cmdCount;l='<span id="span_'+q+'"'+(d?' title="'+d+'"':"")+"><input name='"+q+"' id='"+q+"' size='"+e+"' onkeydown='return Jmol.controls._commandKeyPress(event,\""+q+'","'+g+"\")' /><input  type='button' name='"+q+"Btn' id='"+q+"Btn' value = '"+l+"' onclick='Jmol.controls._commandKeyPress(13,\""+q+'","'+g+"\")' /></span>";a._debugAlert&&alert(l);return a._documentWrite(l)};m._getLink=
function(g,l,e,q,d){g=m._getIdForControl(g,l);if(null==g)return"";void 0!=q&&null!=q||(q="jmolLink"+m._linkCount);void 0!=e&&null!=e||(e=l.substring(0,32));++m._linkCount;l=m._addScript(g,l);e='<span id="span_'+q+'"'+(d?' title="'+d+'"':"")+"><a name='"+q+"' id='"+q+"' href='javascript:Jmol.controls._click(null,"+l+");' onmouseover='Jmol.controls._mouseOver(null,"+l+");return true;' onmouseout='Jmol.controls._mouseOut()' "+m._linkCssText+">"+e+"</a></span>";a._debugAlert&&alert(e);return a._documentWrite(e)};
m._getMenu=function(g,l,e,q,d){var c=m._getIdForControl(g,null);void 0!=q&&null!=q||(q="jmolMenu"+m._menuCount);++m._menuCount;c=typeof l;if(null!=c&&"object"==c&&l.length){var b=l.length;"number"!=typeof e||1==e?e=null:0>e&&(e=b);e='<span id="span_'+q+'"'+(d?' title="'+d+'"':"")+"><select name='"+q+"' id='"+q+"' onChange='Jmol.controls._menuSelected(this)'"+(e?" size='"+e+"' ":"")+m._menuCssText+">";for(q=0;q<b;++q){var f=l[q],c=typeof f,p=null,s=d=null;"object"==c&&null!=f?(p=f[0],d=f[1],s=f[2]):
p=d=f;c=m._getIdForControl(g,p);if(null==c)return"";null==d&&(d=p);"#optgroup"==p?e+="<optgroup label='"+d+"'>":"#optgroupEnd"==p?e+="</optgroup>":(c=m._addScript(c,p),e+="<option value='"+c+(s?"' selected='true'>":"'>")+d+"</option>")}e+="</select></span>";a._debugAlert&&alert(e);return a._documentWrite(e)}};m._getRadio=function(g,l,e,q,d,c,b,f){0==m._radioGroupCount&&++m._radioGroupCount;c||(c="jmolRadioGroup"+(m._radioGroupCount-1));g=m._radio(g,l,e,q,d,c,b?b:c+"_"+m._radioCount,f?f:0);if(null==
g)return"";a._debugAlert&&alert(g);return a._documentWrite(g)};m._getRadioGroup=function(g,l,e,q,d,c){var b=typeof l;if("object"!=b||null==b||!l.length)alert("invalid arrayOfRadioButtons");else{void 0!=e&&null!=e||(e="&#xa0; ");var f=l.length;++m._radioGroupCount;q||(q="jmolRadioGroup"+(m._radioGroupCount-1));for(var p="<span id='"+(d?d:q)+"'>",s=0;s<f;++s){s==f-1&&(e="");var k=l[s],b=typeof k,r=null,p="object"==b?p+(r=m._radio(g,k[0],k[1],k[2],e,q,3<k.length?k[3]:(d?d:q)+"_"+s,4<k.length?k[4]:0,
...
(function(a){var m=function(a){a="&"+a+"=";return decodeURI(("&"+document.location.search.substring(1)+a).split(a)[1].split("&")[0])};a._j2sPath=m("_J2S");a._jarFile=m("_JAR");a._use=m("_USE");a.getVersion=function(){return a._jmolInfo.version};a.getApplet=function(g,l,e){return a._Applet._get(g,l,e)};a.getJMEApplet=function(g,l,e,m){return a._JMEApplet._get(g,l,e,m)};a.getJSVApplet=function(g,l,e){return a._JSVApplet._get(g,l,e)};a.loadFile=function(a,l,e){a._loadFile(l,e)};a.script=function(a,l){a._checkDeferred(l)||
a._script(l)};a.scriptCheck=function(a,l){return a&&a._scriptCheck&&a._ready&&a._scriptCheck(l)};a.scriptWait=function(a,l){return a._scriptWait(l)};a.scriptEcho=function(a,l){return a._scriptEcho(l)};a.scriptMessage=function(a,l){return a._scriptMessage(l)};a.scriptWaitOutput=function(a,l){return a._scriptWait(l)};a.scriptWaitAsArray=function(a,l){return a._scriptWaitAsArray(l)};a.search=function(a,l,e){a._search(l,e)};a.evaluateVar=function(a,l){return a._evaluate(l)};a.evaluate=function(a,l){return a._evaluateDEPRECATED(l)};
a.getAppletHtml=function(g,l){if(l){var e=a._document;a._document=null;g=a.getApplet(g,l);a._document=e}return g._code};a.getPropertyAsArray=function(a,l,e){return a._getPropertyAsArray(l,e)};a.getPropertyAsJavaObject=function(a,l,e){return a._getPropertyAsJavaObject(l,e)};a.getPropertyAsJSON=function(a,l,e){return a._getPropertyAsJSON(l,e)};a.getPropertyAsString=function(a,l,e){return a._getPropertyAsString(l,e)};a.getStatus=function(a,l){return a._getStatus(l)};a.resizeApplet=function(a,l){return a._resizeApplet(l)};
a.restoreOrientation=function(a,l){return a._restoreOrientation(l)};a.restoreOrientationDelayed=function(a,l,e){return a._restoreOrientationDelayed(l,e)};a.saveOrientation=function(a,l){return a._saveOrientation(l)};a.say=function(a){alert(a)};a.clearConsole=function(a){a._clearConsole()};a.getInfo=function(a){return a._info};a.setInfo=function(a,l,e){a._info=l;2<arguments.length&&a._showInfo(e)};a.showInfo=function(a,l){a._showInfo(l)};a.show2d=function(a,l){a._show2d(l)};a.jmolBr=function(){return a._documentWrite("<br />")};
a.jmolButton=function(g,l,e,m,d){return a.controls._getButton(g,l,e,m,d)};a.jmolCheckbox=function(g,l,e,m,d,c,b){return a.controls._getCheckbox(g,l,e,m,d,c,b)};a.jmolCommandInput=function(g,l,e,m,d){return a.controls._getCommandInput(g,l,e,m,d)};a.jmolHtml=function(g){return a._documentWrite(g)};a.jmolLink=function(g,l,e,m,d){return a.controls._getLink(g,l,e,m,d)};a.jmolMenu=function(g,l,e,m,d){return a.controls._getMenu(g,l,e,m,d)};a.jmolRadio=function(g,l,e,m,d,c,b,f){return a.controls._getRadio(g,
l,e,m,d,c,b,f)};a.jmolRadioGroup=function(g,l,e,m,d,c){return a.controls._getRadioGroup(g,l,e,m,d,c)};a.setCheckboxGroup=function(g,l){a.controls._cbSetCheckboxGroup(g,l,arguments)};a.setDocument=function(g){a._document=g};a.setXHTML=function(g){a._isXHTML=!0;a._XhtmlElement=null;a._XhtmlAppendChild=!1;g&&(a._XhtmlElement=document.getElementById(g),a._XhtmlAppendChild=!0)};a.setAppletCss=function(g,l){null!=g&&(a.controls._appletCssClass=g);a.controls._appletCssText=l?l+" ":g?'class="'+g+'" ':""};
...
a.setMenuCss=function(g,l){null!=g&&(a.controls._menuCssClass=g);a.controls._menuCssText=l?l+" ":g?'class="'+g+'" ':""};a.setAppletSync=function(g,l,e){a._syncedApplets=g;a._syncedCommands=l;a._syncedReady={};a._isJmolJSVSync=e};a.setGrabberOptions=function(g){a._grabberOptions=g};a.setAppletHtml=function(g,l){g._code&&(a.$html(l,g._code),g._init&&!g._deferApplet&&g._init())};a.coverApplet=function(a,l){a._cover&&a._cover(l)};a.setFileCaching=function(g,l){g?g._cacheFiles=l:a.fileCache=l?{}:null};
a.updateView=function(a,l,e){a._updateView(l,e)};a.getChemicalInfo=function(g,l,e){l||(l="name");"string"!=typeof applet_or_Identifier&&(g=g._getSmiles());return a._getNCIInfo(g,l,e)};a.saveImage=function(a){switch(a._viewType){case "Jmol":a._script('write PNGJ "'+a._id+'.png"');break;case "JSV":a._script("write PDF");break;case "JME":a._script("print")}}})(Jmol);
...
!0);b.typeString="\\"+b.join("\\");return b};a.searchAndExecuteMethod=function(d,c,b,f){var e=d[b],g=a.getParamsType(f);a._profile&&a.addProfile(c,b,g);if(e.lastParams==g.typeString&&e.lastClaxxRef===c){c=null;if(g.hasCastedNull){c=[];for(g=0;g<f.length;g++)c[g]=f[g]instanceof a.CastedNull?null:f[g]}else c=f;if(null!=e.lastMethod)return e.lastMethod.apply(d,c)}else{e.lastParams=g.typeString;e.lastClaxxRef=c;var k=e.stacks;null==k&&(k=c.prototype[b].stacks);for(var r=!1,l=k.length-1;-1<l;l--)if(r||
k[l]===c){r=a.tryToSearchAndExecute(b,d,k[l].prototype[b],g,f,e);if(!(r instanceof a.MethodException))return r;r=!0}if("construct"!=b)throw new a.MethodNotFoundException(d,c,b,g.typeString);}};a.tracingCalling=!1;a.tryToSearchAndExecute=function(d,c,b,f,e,g){var k=[],r=!0,l;for(l in b)if(92==l.charCodeAt(0)){var m=l.substring(1).split("\\");m.length==f.length&&(k[k.length]=m);r=!1}else if(r&&"funParams"==l&&null!=b.funParams){l=b.funParams;m=l.substring(1).split("\\");m.length==f.length&&(k[0]=m);
break}if(0==k.length)return new a.MethodException;l=a.searchMethod(k,f);if(null!=l){k=null;k=r?b:b["\\"+l];r=null;if(f.hasCastedNull){r=[];for(l=0;l<e.length;l++)r[l]=e[l]instanceof a.CastedNull?null:e[l]}else r=e;if(a.tracingCalling){m=arguments.callee.caller;m=m=m.arguments.callee.caller;if(l="construct"==k.exName&&0<=a.getInheritedLevel(k.exClazz,Throwable)&&!a._initializingException){a._initializingException=!0;var q=m.arguments.callee.caller.arguments.callee.caller,B=q.arguments.callee,D=B.claxxReference;
null==D&&(D=B.exClazz);null==D&&(D=B.claxxOwner);a.pu$hCalling(new a.callingStack(q,D))}if(q=m!==a.instantialize&&m!==a.superCall)B=m.arguments.callee,D=B.claxxReference,null==D&&(D=B.exClazz),null==D&&(D=B.claxxOwner),a.pu$hCalling(new a.callingStack(m,D));g.lastMethod=k;k=k.apply(c,r);q&&a.p0pCalling();l&&a.p0pCalling();return k}g.lastMethod=k;return k.apply(c,r)}return new a.MethodException};a._initializingException=!1;a.searchMethod=function(d,c){for(var b=[],f=0;f<d.length;f++){for(var e=[],
...
f=0;f<c.length;f++)if(null==b){if(null==a.allPackage[c[0]])return!1;b=a.allPackage[c[0]]}else{if(null==b[c[f]])return!1;b=b[c[f]]}if(null!=b)return a.allClasses[d]=!0}return!1};a.defineEnumConstant=function(d,c,b,f,e){var g=null,g=null!=e?new e:new d;a.superConstructor(g,d,[c,b]);null!=f&&0!=f.length&&g.construct.apply(g,f);d[c]=g;d.prototype[c]=g;null==d["$ values"]&&(d["$ values"]=[],d.values=function(){return this["$ values"]});d["$ values"].push(g);return g};a.floatToInt=function(a){return 0>
...
for(var b=0;b<a;b++)c[b]=0;return c},a.haveInt32=!1,Int32Array.prototype.sort=Array.prototype.sort,Int32Array.prototype.int32Fake=function(){});self.Float64Array&&self.Float64Array!=Array?(a.haveFloat64=!0,Float64Array.prototype.sort||(Float64Array.prototype.sort=Array.prototype.sort)):(a.haveFloat64=!1,Float64Array=function(a){a||(a=0);for(var c=Array(a),b=0;b<a;b++)c[b]=0;return c},Float64Array.prototype.sort=Array.prototype.sort,Float64Array.prototype.float64Fake=function(){},Float64Array.prototype.toString=
...
a.pu$hCalling=function(d){a._callingStackTraces[a._callingStackTraces.length]=d};a.p0pCalling=function(){var d=a._callingStackTraces.length;return 0<d?(d=a._callingStackTraces[d-1],a._callingStackTraces.length--,d):null};a.load=function(a,c,b,f){null!=f&&f();delete c$};java.lang.Object=a._O;a._O.getName=a._innerFunctions.getName;System={props:null,$props:{},arraycopy:function(a,c,b,f,e){if(a!==b)for(var g=0;g<e;g++)b[f+g]=a[c+g];else{for(var k=[],g=0;g<e;g++)k[g]=a[c+g];for(g=0;g<e;g++)b[f+g]=k[g]}},
...
Thread.prototype.J2S_THREAD=new Thread;Thread.currentThread=Thread.prototype.currentThread=function(){return this.J2S_THREAD};a.intCast=function(a){var c=(a&4278190080)>>24,b=(a&16711680)>>16,f=(a&65280)>>8;a&=255;return 0!=(c&128)?-(((c&127)<<24)+(b<<16)+(f<<8)+a+1):(c<<24)+(b<<16)+(f<<8)+a};a.shortCast=function(){var a=(n&65280)>>8,c=n&255;return 0!=(a&128)?-(((a&127)<<8)+c+1):(a<<8)+b4};a.byteCast=function(a){return 0!=(a&128)?-((a&127)+1):a&255};a.charCast=function(a){return String.fromCharCode(a&
...
a.alert("[Java2Script] Error: No ClassLoader!")};a.cleanDelegateMethod=function(a){null!=a&&("function"==typeof a&&null!=a.lastMethod&&null!=a.lastParams&&null!=a.lastClaxxRef)&&(a.lastMethod=null,a.lastParams=null,a.lastClaxxRef=null)};a.unloadClass=function(d){var c=a.evalType(d);if(null!=c){a.unloadedClasses[d]=c;for(var b=d.split(/\./),f=null,e=0;e<b.length-1;e++)f=null==f?a.allPackage[b[0]]:f[b[e]];if(null==f){a.allPackage[b[0]]=null;window[b[0]]=null;for(var g in window)0==g.indexOf(d+"$")&&
(a.unloadClass(g),window[g]=null)}else for(g in f[b[b.length-1]]=null,f)0==g.indexOf(b[b.length-1]+"$")&&(a.unloadClass(f.__PKG_NAME__+"."+g),f[g]=null);if(!0==a.allClasses[d])for(g in a.allClasses[d]=!1,a.allClasses)0==g.indexOf(d+"$")&&(a.allClasses[g]=!1);for(var k in c)a.cleanDelegateMethod(c[k]);for(k in c.prototype)a.cleanDelegateMethod(c.prototype[k]);null!=a._Loader&&a._Loader.unloadClassExt(d);return!0}return!1}}a._Loader=function(){};a._Node=function(){a._Loader.initNode(this)};(function(a,
...
a.name||a.status>=b.STATUS_OPTIONALS_LOADED)c.destroyClassNode(a);else{var d=!1;if(null==a.musts||0==a.musts.length||null==a.declaration)d=!0;else for(var d=!0,e=a.musts.length,f=e-1;0<=f;f--){var g=a.musts[f];g.requiredBy=a;if(g.status<b.STATUS_DECLARED){if(c.isClassDefined(g.name)){var l=[];g.status=b.STATUS_OPTIONALS_LOADED;c.destroyClassNode(g);if(null!=g.declaration&&null!=g.declaration.clazzList){for(var m=g.declaration.clazzList,p=0;p<m.length;p++){var q=c.findClass(m[p]);q.status!=b.STATUS_OPTIONALS_LOADED&&
q!==g&&(q.status=g.status,q.declaration=null,c.destroyClassNode(q),null!=q.optionalsLoaded&&(l[l.length]=q))}g.declaration=null}null!=g.optionalsLoaded&&(l[l.length]=g);for(p=0;p<l.length;p++)g=l[p].optionalsLoaded,null!=g&&(l[p].optionalsLoaded=null,g())}else g.status==b.STATUS_CONTENT_LOADED&&c.updateNode(g),g.status<b.STATUS_DECLARED&&(d=!1);a.musts.length!=e&&(f=e=a.musts.length,d=!0)}}if(d){if(a.status<b.STATUS_DECLARED&&(f=a.declaration,null!=f&&(!1==f.executed?(f(),f.executed=!0):f()),a.status=
...
(d==b.STATUS_DECLARED||!c.isClassDefined(f.name)))?f:a.status==d&&(d!=b.STATUS_KNOWN||!0!=c.loadedScripts[a.path])&&(d==b.STATUS_DECLARED||!c.isClassDefined(a.name))?a:null};c.searchClassArray=function(a,d,f){for(var e=0;e<a.length;e++){var g=a[e];if(g.status==f&&(f!=b.STATUS_KNOWN||!0!=c.loadedScripts[g.path])&&(f==b.STATUS_DECLARED||!c.isClassDefined(g.name))||g.random!=d&&(g.random=d,g=c.findNodeNextOptionalClass(g,f),null!=g))return g}return null};c.innerLoadedScripts={};c.interactiveScript=null;
c.needOnloadCheck=!1;c.checkInteractive=function(){if(c.needOnloadCheck){var a=c.interactiveScript;if(!(null!=a&&"interactive"==a.readyState)){c.interactiveScript=null;for(var a=document.getElementsByTagName("SCRIPT"),b=0;b<a.length;b++)"interactive"==a[b].readyState&&null!=a[b].onreadystatechange?(c.interactiveScript=a[b],c.innerLoadedScripts[a[b].src]=!0):c.isOpera&&"loaded"==a[b].readyState&&(null!=a[b].src&&0!=a[b].src.length)&&(c.innerLoadedScripts[a[b].src]=!0)}}};c.load=function(a,d,f,e){c.checkInteractive();
if(d instanceof Array){c.unwrapArray(d);for(var g=0;g<d.length;g++)c.load(a,d[g],f,e,d)}else{"$"==d.charAt(0)&&(d="org.eclipse.s"+d.substring(1));var l=c.mapPath2ClassNode["#"+d];if(null==l){var m=c.findClass(d),l=null!=m?m:new b;l.name=d;g=c.classpathMap["#"+d];null==g&&(g="unknown");l.path=g;c.mappingPathNameNode(l.path,d,l);l.status=b.STATUS_KNOWN;c.addChildClassNode(c.clazzTreeRoot,l,-1)}if(null!=a&&0!=a.length){c.unwrapArray(a);for(g=0;g<a.length;g++)if(m=a[g],!(null==m||0==m.length)&&!c.isClassDefined(m)&&
!c.isClassExcluded(m))m=c.findClass(m),null==m&&(m=new b,m.name=a[g],m.status=b.STATUS_KNOWN),m.requiredBy=l,c.addChildClassNode(l,m,1)}5==arguments.length&&null!=e&&(e.status=l.status,e.clazzList=arguments[4]);l.declaration=e;null!=e&&(l.status=b.STATUS_CONTENT_LOADED);if(null!=f&&0!=f.length){c.unwrapArray(f);for(g=0;g<f.length;g++)if(m=f[g],!(null==m||0==m.length)&&!c.isClassDefined(m)&&!c.isClassExcluded(m))m=c.findClass(m),null==m&&(m=new b,m.name=f[g],m.status=b.STATUS_KNOWN),c.addChildClassNode(l,
m,-1)}}};null!=window.Clazz&&(a.load=c.load);c.findClass=function(a){for(var b=0;;){var b=Math.random(),d="r"+b;if(c.usedRandoms[d]!=b){c.usedRandoms[d]=b;break}}c.clazzTreeRoot.random=b;return c.findClassUnderNode(a,c.clazzTreeRoot)};c.findClassUnderNode=function(a,b){var d=c.clazzTreeRoot.random;if(b.name==a)return b;for(var f=0;f<b.musts.length;f++){var e=b.musts[f];if(e.name==a||e.random!=d&&(e.random=d,e=c.findClassUnderNode(a,e),null!=e))return e}for(f=0;f<b.optionals.length;f++)if(e=b.optionals[f],
e.name==a||e.random!=d&&(e.random=d,e=c.findClassUnderNode(a,e),null!=e))return e;return null};c.mappingPathNameNode=function(a,b,d){var e=c.mapPath2ClassNode,f="@"+a;a=e[f];if(null!=a)if(a instanceof Array){for(var f=!1,g=0;g<a.length;g++)if(a[g].name==b){f=!0;break}f||(a[a.length]=d)}else g=[],g[0]=a,g[1]=d,e[f]=g;else e[f]=d;e["#"+b]=d};c.loadClassNode=function(a){var b=a.name;if(!c.isClassDefined(b)&&!c.isClassExcluded(b)){var d=c.getClasspathFor(b);a.path=d;c.mappingPathNameNode(d,b,a);if(!c.loadedScripts[d])return c.loadScript(d,
...
if(null!=e)return e;e=d.indexOf("java/lang/ClassLoader.js");if(-1!=e)return d.substring(0,e)}return null};c.J2SLibBase=null;c.fastGetJ2SLibBase=function(){null==c.J2SLibBase&&(c.J2SLibBase=c.getJ2SLibBase());return c.J2SLibBase};c.assurePackageClasspath=function(a){var b=window[a+".registered"];!1!=b&&(!0!=b&&null==c.classpathMap["@"+a])&&(window[a+".registered"]=!1,b=c.fastGetJ2SLibBase(),null==b&&(b="j2s"),c.packageClasspath(a,b,!0))};c.loadClass=function(e,f,g,l){if("boolean"==typeof f)return a.evalType(e);
c.assurePackageClasspath("java");c.assurePackageClasspath("core");(0==e.indexOf("org.eclipse.swt")||0==e.indexOf("$wt"))&&c.assurePackageClasspath("org.eclipse.swt");0==e.indexOf("junit")&&c.assurePackageClasspath("junit");c.keepOnLoading=!0;if(!g&&(0!=c.pkgRefCount&&e.lastIndexOf(".package")!=e.length-8||!c.isClassDefined(c.runtimeKeyClass)&&0!=e.indexOf("java.")))l=c.queueBe4KeyClazz,l[l.length]=[e,f];else if(!c.isClassDefined(e)&&!c.isClassExcluded(e)){var m=c.getClasspathFor(e),p=c.loadedScripts[m];
l=c.classQueue;if(!p)for(g=l.length-1;0<=g;g--)if(l[g].path==m||l[g].name==e)p=!0;if(p){if(null!=f&&(p=c.findClass(e),null!=p))if(null==p.optionalsLoaded)p.optionalsLoaded=f;else if(f!=p.optionalsLoaded){var q=p.optionalsLoaded;p.optionalsLoaded=function(){q();f()}}}else{p=null;null!=a.unloadedClasses[e]&&(p=c.findClass(e));null==p&&(p=new b);p.name=e;p.path=m;c.mappingPathNameNode(m,e,p);p.optionalsLoaded=f;p.status=b.STATUS_KNOWN;var s=!1;for(g=l.length-1;0<=g;g--)if(l[g].status!=b.STATUS_OPTIONALS_LOADED){s=
!0;break}if(m.lastIndexOf("package.js")==m.length-10){m=!1;for(g=l.length-1;0<=g;g--){e=l[g].name;if(e.lastIndexOf("package.js")==e.length-10){l[g+1]=p;m=!0;break}l[g+1]=l[g]}m||(l[0]=p)}else s&&(l[l.length]=p);s||(e=!1,null!=f&&(e=c.isLoadingEntryClass,c.isLoadingEntryClass=!0),c.addChildClassNode(c.clazzTreeRoot,p,1),c.loadScript(p.path),null!=f&&(c.isLoadingEntryClass=e))}}else if(null!=f&&c.isClassDefined(e)&&(e=c.findClass(e),null==e||e.status>=b.STATUS_OPTIONALS_LOADED))l?window.setTimeout(f,
25):f()};c.loadJ2SApp=function(b,e,f){if(null!=b){var g=b;"$"==b.charAt(0)&&(g="org.eclipse.s"+b.substring(1));var l=-1;if(-1!=(l=g.indexOf("@")))b=g.substring(l+1),c.setPrimaryFolder(b),g=g.substring(0,l),l=g.lastIndexOf("."),-1!=l&&(l=g.substring(0,l),c.packageClasspath(l,b));if(null==e||!(e instanceof Array))e=[];if(null==f){var m=g,p=e;f=function(){a.evalType(m).main(p)}}else f=f(g,e);c.loadClass(g,f)}};c.loadJUnit=function(b,e){c.loadJ2SApp(b,e,function(b){return function(){c.loadClass("junit.textui.TestRunner",
...
!1;a="undefined"==typeof a?"":null==a?"null":""+a;0<a.length&&(e=a.charAt(a.length-1),"\n"==e?(a=1<a.length?"\r"==a.charAt(a.length-2)?a.substring(0,a.length-2):a.substring(0,a.length-1):"",g=!0):"\r"==e&&(a=a.substring(0,a.length-1),g=!0));var l=null;a=a.replace(/\t/g,q.c160);if(q.splitNeedFixed)try{l=q.splitIntoLines(a)}catch(k){window.popup(k.message)}else l=a.split(/\r\n|\r|\n/g);for(e=0;e<l.length;e++){var m=null;if(q.metLineBreak||0==q.linesCount||1>b.childNodes.length)m=document.createElement("DIV"),
b.appendChild(m),m.style.whiteSpace="nowrap",q.linesCount++;else try{m=b.childNodes[b.childNodes.length-1]}catch(G){m=document.createElement("DIV"),b.appendChild(m),m.style.whiteSpace="nowrap",q.linesCount++}var A=document.createElement("SPAN");m.appendChild(A);A.style.whiteSpace="nowrap";null!=c&&(A.style.color=c);0==l[e].length&&(l[e]=String.fromCharCode(160));A.appendChild(document.createTextNode(l[e]));q.pinning||(b.scrollTop+=100);q.metLineBreak=e!=l.length-1?!0:g}g=b.parentNode.className;!q.pinning&&
